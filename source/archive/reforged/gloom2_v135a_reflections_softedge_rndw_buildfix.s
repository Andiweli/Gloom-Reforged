...
g2_prepare_reflection_column
	...
	; v134: do not draw reflections directly in front of the player/gun.
	; The projectile is then still visually inside the weapon/HUD area and can
	; corrupt the left side of the gun overlay.
	cmp	#1<<grdshft,d2
	blt	.no_reflect
	move	d7,g2_shadow_curx
	move	d7,d0
...
g2_reflect_rgb
	; v134: very dark edge-like tones from the projectile/upgrade palette
	; family, closer to the darker rim pixels than the bright cores.
	dc	$320,$030,$300,$033,$303,$320,$030,$300
