	...
	;gloom2p96_c86l: P96 overlay disabled; TWO PLAYER uses gloom.s-style crop/window sizing, not stretch scaling.
	;
...
debugser	equ	0
debugmem	equ	0
g2p96_overlay_enabled	equ	0	;c86n: 0 disables P96 overlay, -1 re-enables old c85 P96 preview path
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86n P96 off 2P floor/menu fix active',10
