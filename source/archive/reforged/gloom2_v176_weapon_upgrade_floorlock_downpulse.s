...
.rx_ok
	move	d0,g2_shadow_rx
	; v176: keep weapon-upgrade reflections fixed on the floor under the
	; bouncing pickup.  Other reflection owners keep the v174 compensation.
	clr	g2_shadow_yoff
	move.l	ob_hit(a2),d1
	cmp.l	#weapongot,d1
	beq.s	.weapon_floor_yoff
	move	ob_y(a2),d0
	neg	d0
	bra.s	.scale_yoff
.weapon_floor_yoff	move	ob_y(a2),d0
.scale_yoff	ext.l	d0
	asl.l	#7,d0
	divs	d2,d0
	cmp	#30,d0
