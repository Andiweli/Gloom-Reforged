...
.g2dither_loop
	...
	cmp	#4,d6
	beq.s	.g2thr4
	; threshold 1: one sample in sixteen, based on 4x4-ish pattern
	tst.b	g2_cur_xmod
	bne.s	.g2basepix
	btst	#0,d2
	bne.s	.g2basepix
	...
	bra.s	.g2altpix
.g2thr4
	; about 25 percent alternate pixels
	tst.b	g2_cur_xmod
	bne.s	.g2basepix
	btst	#0,d2
	bne.s	.g2basepix
	bra.s	.g2altpix
.g2thr8
	; about 50 percent checker/crosshatch
	tst.b	g2_cur_xmod
	beq.s	.g2thr8_x0
	btst	#0,d2
	beq.s	.g2altpix
...
.g2thr8_x0
	...
	bra.s	.g2basepix
.g2thr12
	; about 75 percent alternate pixels, inverse of sparse base pattern
	tst.b	g2_cur_xmod
	bne.s	.g2altpix
	btst	#0,d2
	bne.s	.g2altpix
...
; 20px each side: 75/50/25/sparse ordered mix as distance increases.
g2blend_boundary20
	movem.l	d0-d7/a0-a2,-(a7)
