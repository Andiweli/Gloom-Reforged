...
.g2v190dw_flat_shade
	...
	move.l	0(a5,d5*4),a5
	; v190ej: floor/ceiling shade-step Bayer blend.  This blends only
	; neighbouring fog palettes across the hard darktable bands; texture
	; projection and clipping stay untouched.
	clr	g2_bayer_thresh
	cmp	#14,d5
...
.hiteok	;
	...
	move.l	0(a2,d5*4),a4
	; v190ej: dither only the shade-step itself.  No wall column is skipped;
	; the texel chooses current or next darker palette through a 4x4 Bayer
	; pattern inside each 64-unit darktable interval.
	clr	g2_bayer_thresh
	cmp	#14,d5
	bcc.s	.g2v190ej_wallblend_setup_done
	move	vd_z(a0),d6
	tst	g2_visibility
...
.g2v190ej_wallblend_dist_ok
	...
	and	#$3f,d5
	lsr	#2,d5
	beq.s	.g2v190ej_wallblend_setup_done
	move	d5,g2_bayer_thresh
	move	vd_pal(a0),d5
	addq	#1,d5
	cmp	#14,d5
...
g2_visibility	dc	-1	;v190ej -1=DEFAULT, +1=ADVANCED; saved in gloom.cfg
...
g2_bayer_thresh	dc	0	;v190ej 0=no blend, 1..15 shade-band amount
