...
.rabs_ok	move	g2_shadow_rx(pc),d2
	cmp	d2,d1
	bgt	.rts
	; v134: hard-edged but more elliptical coloured floor mark.  Wider
	; centre band and thinner outer columns make it read as an oval rather
	; than a tiny vertical blob.
	moveq	#2,d5	;outer edge vertical offset
	moveq	#0,d6	;1 row
	move	d2,d3
	mulu	#3,d3
