...
mainloop	; v190hy cleanup: log frame counter removed
	...
	move	escape(pc),d0
	beq.s	g2zdo_noesc
	cmp	#2,gametype	; c86zdn: diagnostic - block confirmed auto dogamemenu EXIT in TWO PLAYER COMBAT
	beq.s	g2zdn_combat_ignore_escape_menu
	jsr	dogamemenu
	clr	escape
	bra.s	g2zdo_noesc
g2zdn_combat_ignore_escape_menu
	clr	escape		; c86zdn: keep Combat running; ESC menu disabled only in TWO PLAYER COMBAT for this test
g2zdo_noesc	; v190hy cleanup: log marker removed
