...
g2fill_void_fog
	...
	beq.w	.g2fv_done
	lea	paladjust(pc),a3
	; Use a very dark non-black neutral/brownish fog colour so untouched
	; far openings blend with the surrounding far wall shading instead of
	; reading as pure-black square cut-outs.
	move	#$221,d0
	moveq	#0,d1
	move.b	0(a4,d0.w),d1
	and	#$00ff,d1
