...
.g2v190dw_wall_shade_ok
	...
	; v190hx: Gloom/Gloom Deluxe keep the confirmed v190ew smooth path.
	; Gloom3/Zombie Massacre use different palette/remap data where shade 14
	; remains too visible at the advanced edge, so restore only the final
	; 8..16-width Bayer-to-fog wall fade for profiles 2/3.
	cmp	#2,g2_game_profile
	beq.s	.g2v190hx_g3zm_wallfade
	cmp	#3,g2_game_profile
	bne.s	.g2v190dy_wallfade_done
.g2v190hx_g3zm_wallfade
	cmp	#(8<<grdshft),d2
