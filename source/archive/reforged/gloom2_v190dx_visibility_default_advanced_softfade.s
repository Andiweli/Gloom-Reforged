...
.g2v190dw_wall_shade_ok
	...
	move	0(a2,d6*2),d3
	; v190dx: ADVANCED keeps the doubled view distance but softens
	; the far wall entry.  The last two texture-widths before the
	; extended clip are dithered/faded into black instead of allowing
	; walls to pop in at full dark-fog texture in one step.
	tst	g2_visibility
	ble.s	.g2v190dx_wallfade_done
	cmp	#(14<<grdshft),d2
	blo.s	.g2v190dx_wallfade_mid
	moveq	#15,d3
	bra.s	.g2v190dx_wallfade_done
.g2v190dx_wallfade_mid
	cmp	#(12<<grdshft),d2
	blo.s	.g2v190dx_wallfade_done
	move	d2,d6
	sub	#(12<<grdshft),d6
	lsr	#7,d6	; 0..3 over the 12..14 texture-width fade band
	move	d7,d0
	and	#3,d0
	cmp	d6,d0
	bge.s	.g2v190dx_wallfade_done
	moveq	#15,d3
.g2v190dx_wallfade_done
	movem	d2-d3,vd_z(a0)
	;
	move	#-256,d3
	sub	camy(pc),d3
...
g2_visibility	dc	-1	;v190dx -1=DEFAULT, +1=ADVANCED; advanced extends view/fog safely
