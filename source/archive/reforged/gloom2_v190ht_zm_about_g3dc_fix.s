...
.g2v190cs_about_zm
	bsr	dispoff
	jsr	g2v145_show_clean_title	; v190hs: ABOUT stays clean, no g3-dc overlay here
...
zmecsfiles	dc.l	gloom
	...
	dc.b	'pixs/title.pal',0
	even
	dc.l	gloombrush	; v190ht: keep Zombie Massacre g3-dc available for title/menu overlay on ECS/non-AGA paths too
	dc.b	'pixs/g3-dc',0
	even
	dc.l	planar_palette
