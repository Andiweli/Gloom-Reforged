...
drawsolidstrip	macro
	...
	;d0=chunkymod
	;
	; v190bs: this macro now uses d7 for per-pixel Bayer-like tests,
	; so preserve the renderwalls DBF counter.
	move	d7,-(a7)
...
.hiteok	;
	...
	move.l	0(a2,d5*4),a4
	clr	g2_cur_thr
	; v190bs: clean ordered dither based on distance phase instead of
	; screen-column boundary tables.  This avoids the thick vertical stripes
	; from v190br, while still mixing the two neighbouring shade palettes.
	cmp	#5,d5
	blo.s	.g2bs_nodither_setup
	cmp	#14,d5
	bhs.s	.g2bs_nodither_setup
	move	vd_z(a0),d6
	and	#63,d6
	cmp	#20,d6
	bge.s	.g2bs_check_high
	; first 20 distance steps of a shade: mix in previous/lighter shade
	tst	d5
	beq.s	.g2bs_nodither_setup
	move	d5,d7
	subq	#1,d7
	move.b	d7,g2_cur_altpal
	moveq	#20,d7
	sub	d6,d7
	cmp	#15,d7
	bls.s	.g2bs_store_thr
	moveq	#15,d7
	bra.s	.g2bs_store_thr
.g2bs_check_high
	cmp	#44,d6
	bls.s	.g2bs_nodither_setup
	cmp	#13,d5
	bhs.s	.g2bs_nodither_setup
	move	d5,d7
	addq	#1,d7
	...
	moveq	#15,d7
.g2bs_store_thr
	move.b	d7,g2_cur_thr
.g2bs_nodither_setup
	sub	d3,d2
	add.l	d3,d2
	moveq	#0,d6
	move.b	g2_cur_thr(pc),d6
	beq.s	.g2bs_vertloop_base
	moveq	#0,d5
	move.b	g2_cur_altpal(pc),d5
	move.l	0(a2,d5*4),a5
.g2bs_vertloop_dither
	; Ordered 4x4-ish pattern without ADD/LSL before ADDX.  The wall
	; texture scaler relies on the X flag for addx.l d3,d2; arithmetic
	; pattern math here would corrupt texture stepping and produce stripes.
	move.b	0(a3,d2),d5
	cmp	#12,d6
	beq.s	.g2bs_thr12
	cmp	#8,d6
	...
	cmp	#4,d6
	beq.s	.g2bs_thr4
	; threshold 1: sparse alternate pixels
	tst	g2_cur_xmod
	bne.s	.g2bs_basepix
	btst	#0,d2
	bne.s	.g2bs_basepix
...
.g2bs_thr8_x0
	...
	bra.s	.g2bs_basepix
.g2bs_thr12
	; about 75 percent alternate pixels
	tst	g2_cur_xmod
	bne.s	.g2bs_altpix
	btst	#0,d2
	bne.s	.g2bs_altpix
...
.g2bs_pixdone
	addx.l	d3,d2
	add.l	d0,a1
	dbf	d4,.g2bs_vertloop_dither
	bra.s	.g2bs_vert_done
.g2bs_vertloop_base
	move.b	0(a3,d2),d5
	move.b	0(a4,d5),(a1)
	addx.l	d3,d2
	add.l	d0,a1
	dbf	d4,.g2bs_vertloop_base
.g2bs_vert_done
.vertskip	;
	subq	#1,d1
	blt.s	.rts
