...
.g2amo_do
	...
	add.l	d2,d2
	add.l	d2,ob_z(a0)
	; v73: lower the vertical muzzle correction again.  #36 placed the first
	; projectile frame too high/near and made it fill half the screen.  Keep a
	; small lift so it starts around the visible weapon area, not below the bar.
	sub	#12,ob_y(a0)
.g2amo_done
	movem.l	(a7)+,d0-d2/a1
	rts
