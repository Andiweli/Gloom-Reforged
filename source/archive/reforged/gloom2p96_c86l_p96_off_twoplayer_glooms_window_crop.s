...
debugser	equ	0
debugmem	equ	0
g2p96_overlay_enabled	equ	0	;c86l: 0 disables P96 overlay, -1 re-enables old c85 P96 preview path
	;
...
drawall_	tst	twowins		; c54: gloom2 never had real 2P split; avoid P2 fullscreen overwrite
	...
	;
	; c86l: mimic gloom.s two-player window behaviour.  Do not render a
	...
	jsr	calcscene
	jsr	drawscene
	jsr	g2twop_draw_half_hud	;c86l: HUD anchored to split edges, not render crop
	;
