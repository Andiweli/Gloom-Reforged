...
g2_make_floorfx_flags
	moveq	#0,d6
	; blob shadow: only real living monsters, not players, pickups or bullets
	tst	g2_blobshadow
	ble	.no_blob
	tst	ob_colltype(a5)
	bne	.no_blob
...
game_ceil	dc.b	'            CEILING: YES                        ',0
	dc.b	92,0
game_blob	dc.b	'        BLOB SHADOW: YES                        ',0
game_reflections	dc.b	'        REFLECTIONS: YES                        ',0
	dc.b	92,0
...
g2_blobshadow	dc	1	;v116 1=on, -1=off
g2_reflections	dc	1	;v116 1=on, -1=off
