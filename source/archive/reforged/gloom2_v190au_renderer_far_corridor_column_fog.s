...
g2fill_void_fog
	; v190au: empty far wall columns are not painted with a fixed flat RGB.
...
.nofloor	;
	...
	jsr	g2log_drawstep
	; v190as: fill still-empty scene pixels with a very dark fog colour so
	; far corridor openings do not stay pure black while surrounding far
	; walls are already darkened by the distance shading.
	jsr	g2fill_void_fog
	;
