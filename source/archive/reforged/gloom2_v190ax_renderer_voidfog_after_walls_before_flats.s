...
g2fill_void_fog
	; v190av/v190au: empty far wall columns are not painted with a fixed flat RGB.
	; Instead, copy the already-distance-shaded neighbouring wall colour into
	; still-empty pixels.  This makes far corridor/room openings fade with the
	; surrounding walls instead of becoming a black or differently-coloured box.
	movem.l	d0-d7/a0-a6,-(a7)
	move.l	chunky(pc),a0
	tst.l	a0
	beq.w	.g2fv_done
