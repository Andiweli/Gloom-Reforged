...
showstats
	...
	move.l	panel(pc),d0
	beq.w	.g2hud_done
	cmp	#160,width	; v190gq: hide top HUD for TINY/SMALL/MEDIUM view sizes
	bcs.w	.g2hud_done
	;
...
.redrawmenu
	...
	; v190gq: Gloom3/ZM keep START LEVEL but use a compact shifted menu.
	cmp	#2,g2_game_profile
...
.use_g3zm_startmenu
	...
	jsr	initmenu
	move	#1,curropt	; shifted menu: ONE PLAYER GAME is row 1
	bra.s	.sel
.use_linked_menu
	lea	startmenu2,a4
	jsr	initmenu
...
.notlinked
	...
	and	#$00ff,d0
	cmp	#12,numopts	; v190gq: Gloom3/ZM shifted full menu mapping
	beq	.g2v190gq_notlinked
	; v190gp: startmenu row mapping is now shared by all local profiles.
	; Keep the old compat handler below unused for safety/linked legacy data.
	tst	d7
...
g2v190i_levelselect_loadscripts
	...
	clr	g2v190f_level_index
	bsr	permit
	cmp	#1,g2_game_profile	; v190gq: Classic Gloom keeps only MAP1_1 in START LEVEL
	bne.s	.g2v190gq_try_level_scripts
	jsr	g2v190i_level_default
	bra	.doneio
.g2v190gq_try_level_scripts
...
.titlemenu_main	move	#-1,g2v154_titlemenu_lines
	...
	bra.s	.titlemenu_y_done
.titlemenu_g3zm	move	#3,g2v154_titlemenu_lines	; v190gq: 12-row shifted full menu
