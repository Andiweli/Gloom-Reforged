...
.rx_max_ok
	...
	moveq	#1,d0	;fallback: very dark palette entry
	move.l	planar_remap(pc),a0
	tst.l	a0
	beq	.col_ok
	move	#$111,d1
...
.abs_ok	move	g2_shadow_rx(pc),d2
	cmp	d2,d1
	bgt	.rts
	; hard ellipse thickness by horizontal distance:
	; centre = 5 rows, middle = 3 rows, edge = 1 row.
	moveq	#2,d5	;start row offset below feet
