	...
	;gloom2_c86zdz: clean reset branch from c86zc7/c86zcn; add only confirmed other-player reflection in TWO PLAYER modes. No logger, no ESC/Input/Dogamemenu/Table/Loadobj experiments.
	;
...
.play	;
	jsr	initnewgame
	cmp	#2,gametype
	bne.s	.g2zed_no_after_initnewgame_log
	jsr	permit
	lea	g2zed_stage_after_initnewgame,a0
	move.l	#g2zed_stage_after_initnewgame_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
.g2zed_no_after_initnewgame_log
	tst	gametype
	bmi	.intro2
	move	#-1,p96preview_gameactive	;gloom2p96_c14: gameplay is now the visible source
	cmp	#2,gametype
	bne.s	.g2zed_no_before_free_title_log
	jsr	permit
	lea	g2zed_stage_before_free_title,a0
	move.l	#g2zed_stage_before_free_title_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
.g2zed_no_before_free_title_log
	jsr	g2v190p_free_title_assets	; v190p: free title art during gameplay to keep memory contiguous
	cmp	#2,gametype
	bne.s	.g2zed_no_after_free_title_log
	jsr	permit
	lea	g2zed_stage_after_free_title,a0
	move.l	#g2zed_stage_after_free_title_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
.g2zed_no_after_free_title_log
	;
	;bsr	smallfont
	tst	twowins
	beq.s	.n2
	bsr	swaphflags
.n2	cmp	#2,gametype
	bne.s	.g2zed_no_before_execscript_log
	jsr	permit
	lea	g2zed_stage_before_execscript_med,a0
	move.l	#g2zed_stage_before_execscript_med_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
.g2zed_no_before_execscript_log
	jsr	execscript_med
.wmf	tst	fadevol
	bne.s	.wmf
	tst	twowins
...
.play	add	#49,d0
	...
	bsr	permit
	lea	g2zec_stage_before_loadfiles,a0
	move.l	#g2zec_stage_before_loadfiles_len,d3
	jsr	g2zec_stage_log
	lea	combatfiles(pc),a0
	bsr	loadfiles
	lea	g2zec_stage_after_loadfiles,a0
	move.l	#g2zec_stage_after_loadfiles_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	jsr	permit
	lea	g2zed_stage_after_combat_forbid,a0
	move.l	#g2zed_stage_after_combat_forbid_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	rts
normalgame	;
...
execscript_med	;
	cmp	#2,gametype
	bne.s	.g2zed_no_execscript_entry_log
	jsr	permit
	lea	g2zed_stage_execscript_med_entered,a0
	move.l	#g2zed_stage_execscript_med_entered_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
.g2zed_no_execscript_entry_log
	jsr	waitquiet
	;
	move.l	loadingmed(pc),d0
	beq.s	execscript
...
execscript	cmp	#2,gametype
	bne.s	.g2zed_execscript_not_combat
	jsr	permit
	lea	g2zed_stage_execscript_to_scriptplay,a0
	move.l	#g2zed_stage_execscript_to_scriptplay_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	bra	scriptplay	;no script for combat game!
.g2zed_execscript_not_combat
	;
...
scriptplay	;
	...
	;
	jsr	permit
	lea	g2zed_stage_before_pickcombat,a0
	move.l	#g2zed_stage_before_pickcombat_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	bsr	pickcombat
	jsr	permit
	lea	g2zed_stage_after_pickcombat,a0
	move.l	#g2zed_stage_after_pickcombat_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	; c86zef: prove whether the post-pickcombat forbid returns.
	jsr	permit
	lea	g2zef_stage_after_pickcombat_forbid,a0
	move.l	#g2zef_stage_after_pickcombat_forbid_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	bra.s	.gotname
	;
...
.gotname	;
	...
	; c86zef: we are in the forbid section; temporarily permit only for the logger.
	jsr	permit
	lea	g2zef_stage_after_c2p_check,a0
	move.l	#g2zef_stage_after_c2p_check_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	...
	jsr	permit
	lea	g2zef_stage_after_zerolists,a0
	move.l	#g2zef_stage_after_zerolists_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	;
	clr.l	player1
...
.p2	;
	jsr	permit
	lea	g2zef_stage_after_player_clear,a0
	move.l	#g2zef_stage_after_player_clear_len,d3
	jsr	g2zec_stage_log
	jsr	forbid
	bsr	permit
	lea	g2zef_stage_before_map_load,a0
	move.l	#g2zef_stage_before_map_load_len,d3
	jsr	g2zec_stage_log
	;
...
g2v11_c2pfail_scriptplay
	...
	bra	gameover
g2v10_map_loaded
	lea	g2zef_stage_after_map_load,a0
	move.l	#g2zef_stage_after_map_load_len,d3
	jsr	g2zec_stage_log
	;
	bsr	initmap
	lea	g2zef_stage_after_initmap,a0
	move.l	#g2zef_stage_after_initmap_len,d3
	jsr	g2zec_stage_log
	bsr	loadtxts
	lea	g2zef_stage_after_loadtxts,a0
	move.l	#g2zef_stage_after_loadtxts_len,d3
	jsr	g2zec_stage_log
	move	#$a3f7,d0
	jsr	seedrnd
	moveq	#1,d0
	jsr	execevent
	lea	g2zef_stage_after_execevent,a0
	move.l	#g2zef_stage_after_execevent_len,d3
	jsr	g2zec_stage_log
	jsr	g2v190cx_build_g1_tables	; v190cx: synthetic palette/remap for original Gloom
	lea	g2zef_stage_after_g1_tables,a0
	move.l	#g2zef_stage_after_g1_tables_len,d3
	jsr	g2zec_stage_log
	bsr	forbid
	;
...
; c86zec: DOS-safe combat loadfiles logger.
; Diagnostic only. Called only inside the existing permit window around combat loadfiles.
g2zec_stage_log
	movem.l	d0-d7/a0-a6,-(a7)
	move.l	a0,a2
	move.l	d3,d4
	move.l	dosbase,d0
	beq	g2zec_stage_log_done
	move.l	d0,a6
	lea	g2zec_log_name(pc),a0
	move.l	a0,d1
	move.l	#1006,d2	; MODE_NEWFILE
	jsr	-30(a6)	; Open
	move.l	d0,d7
	...
	move.l	d7,d1
	jsr	-36(a6)	; Close
g2zec_stage_log_done
	movem.l	(a7)+,d0-d7/a0-a6
	rts

g2zec_log_name	dc.b	'DH3:gloom_combat_stage.txt',0
	even
g2zec_stage_before_loadfiles	dc.b	'C10 before combat loadfiles',10
g2zec_stage_before_loadfiles_len	equ	*-g2zec_stage_before_loadfiles
g2zec_stage_after_loadfiles	dc.b	'C11 after combat loadfiles',10
g2zec_stage_after_loadfiles_len	equ	*-g2zec_stage_after_loadfiles
g2zed_stage_after_combat_forbid	dc.b	'C12 after combat forbid',10
g2zed_stage_after_combat_forbid_len	equ	*-g2zed_stage_after_combat_forbid
g2zed_stage_after_initnewgame	dc.b	'C13 after initnewgame return',10
g2zed_stage_after_initnewgame_len	equ	*-g2zed_stage_after_initnewgame
g2zed_stage_before_free_title	dc.b	'C14 before free title assets',10
g2zed_stage_before_free_title_len	equ	*-g2zed_stage_before_free_title
g2zed_stage_after_free_title	dc.b	'C15 after free title assets',10
g2zed_stage_after_free_title_len	equ	*-g2zed_stage_after_free_title
g2zed_stage_before_execscript_med	dc.b	'C16 before execscript_med',10
g2zed_stage_before_execscript_med_len	equ	*-g2zed_stage_before_execscript_med
g2zed_stage_execscript_med_entered	dc.b	'C17 execscript_med entered',10
g2zed_stage_execscript_med_entered_len	equ	*-g2zed_stage_execscript_med_entered
g2zed_stage_execscript_to_scriptplay	dc.b	'C18 execscript to scriptplay',10
g2zed_stage_execscript_to_scriptplay_len	equ	*-g2zed_stage_execscript_to_scriptplay
g2zed_stage_before_pickcombat	dc.b	'C19 before pickcombat',10
g2zed_stage_before_pickcombat_len	equ	*-g2zed_stage_before_pickcombat
g2zed_stage_after_pickcombat	dc.b	'C20 after pickcombat/loadtile',10
g2zed_stage_after_pickcombat_len	equ	*-g2zed_stage_after_pickcombat
g2zef_stage_after_pickcombat_forbid	dc.b	'C21 after post-pickcombat forbid',10
g2zef_stage_after_pickcombat_forbid_len	equ	*-g2zef_stage_after_pickcombat_forbid
g2zef_stage_after_c2p_check	dc.b	'C22 after c2p check',10
g2zef_stage_after_c2p_check_len	equ	*-g2zef_stage_after_c2p_check
g2zef_stage_after_zerolists	dc.b	'C23 after zerolists',10
g2zef_stage_after_zerolists_len	equ	*-g2zef_stage_after_zerolists
g2zef_stage_after_player_clear	dc.b	'C24 after player clear',10
g2zef_stage_after_player_clear_len	equ	*-g2zef_stage_after_player_clear
g2zef_stage_before_map_load	dc.b	'C25 before map load',10
g2zef_stage_before_map_load_len	equ	*-g2zef_stage_before_map_load
g2zef_stage_after_map_load	dc.b	'C26 after map load',10
g2zef_stage_after_map_load_len	equ	*-g2zef_stage_after_map_load
g2zef_stage_after_initmap	dc.b	'C27 after initmap',10
g2zef_stage_after_initmap_len	equ	*-g2zef_stage_after_initmap
g2zef_stage_after_loadtxts	dc.b	'C28 after loadtxts',10
g2zef_stage_after_loadtxts_len	equ	*-g2zef_stage_after_loadtxts
g2zef_stage_after_execevent	dc.b	'C29 after execevent',10
g2zef_stage_after_execevent_len	equ	*-g2zef_stage_after_execevent
g2zef_stage_after_g1_tables	dc.b	'C30 after g1 tables before forbid',10
g2zef_stage_after_g1_tables_len	equ	*-g2zef_stage_after_g1_tables
