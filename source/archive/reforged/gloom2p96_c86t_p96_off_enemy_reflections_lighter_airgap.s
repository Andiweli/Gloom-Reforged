	...
	;gloom2p96_c86t: c86s enemy reflections lighter with air-gap floor start.
	;
...
.rh_max_ok
	...
	cmp	d1,d0
	bgt.s	.no_ref
	; c86t: airborne/floating enemies should not mirror directly below
	; their visible sprite.  If the owner has a negative world Y offset, push
	; the reflection start further down, scaled by distance and capped safely.
	move	ob_y(a2),d1
	bpl.s	.airgap_done
	neg	d1
	ext.l	d1
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86t P96 off enemy reflections lighter airgap active',10
