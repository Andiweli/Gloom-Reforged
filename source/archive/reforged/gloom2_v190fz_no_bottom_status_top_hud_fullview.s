...
.g2dg_have_shape_index
	...
	move	6(a0),d3		;height
	move	#240,d4
	sub	d3,d4		;v190fz: bottom-align gun to full-height playfield
...
showstats	;
	;a5=player
	; v190fz: draw the compact gloom.s-style HUD at the top-left.
	; The lower Gloom2/smallfont2 status panel is no longer used.
...
.g2hud_nohp
	...
	blt.s	.g2hud_done
	move	ob_weapon(a5),d4
	neg	d4
	add	#49,d4		; active weapon cell: 49-ob_weapon
	moveq	#44,d5
	moveq	#1,d6
.g2hud_wploop
	move.l	smallfont_(pc),a0
