	...
	;gloom2p96_c86f: P96 overlay off; TWO PLAYER window size uses wider FOV without aspect stretch.
	;
...
debugser	equ	0
debugmem	equ	0
g2p96_overlay_enabled	equ	0	; c86f: 0 hides/disables P96 overlay, -1 re-enables old c85 P96 preview path
	;
...
g2twop_drawall_split
	...
	;
	jsr	g2twop_prepare_view_width	;c86f: use current WINDOW SIZE width for 2P split
	...
	move	#-1,g2twop_aspect_mode	;c86f: width changes FOV, not object aspect
	;
...
g2twop_prepare_view_width
	; c86f: WINDOW SIZE controls two-player field width; aspect stays height-locked.
...
g2twop_set_half_view
	; c86f: physical split half remains 320x120. Logical render width follows
