...
.g2dg_frameok
	...
	bhi.w	.g2dg_done
	;
	;destination: bottom centred just above the 224..239 statusbar.
	move	#160,d4
...
.g2dg_xok
	move	#224,d7
	sub	d3,d7		;y = statusbar top - height
	bpl.s	.g2dg_yok
	moveq	#0,d7
.g2dg_yok
	move.l	player_(pc),a5
	beq.s	.g2dg_nobob
	tst.l	ob_movspeed(a5)
	beq.s	.g2dg_nobob
	move	vbcounter,d0
	and	#3,d0
	add	d0,d7
...
.g2dg_yloop
	...
	and	#$0fff,d0
	move.b	0(a4,d0.w),d0	;RGB -> screen LUT index
	move.b	0(a6,d0.w),(a5)	;LUT -> scrambled C2P index
.g2dg_skip
	add.l	#320,a5
	dbf	d7,.g2dg_yloop
	addq.l	#1,a1
...
g2loadgun
	;v40: try the real gun.bin locations used by ZGloom/data sets.
	;Keep it optional: missing gun means no weapon overlay, not a load error.
	movem.l	d0-d1/a0,-(a7)
	tst.l	gunpic
	bne.s	.g2lg_done
	moveq	#1,d1
