	...
	;gloom2p96_c86s: c86r enemy reflections with earlier/softer fade-out.
	;
...
; c86s: safe mirrored enemy floor reflection with earlier fade.
...
.yloop
	cmp.l	a1,a0
	bhi	.rts
	; c86s: fade earlier.  Keep the first few reflected rows readable,
	; then quickly thin out to avoid a long mirrored smear below enemies.
	move	g2_enemy_ref_curx(pc),d0
	add	d5,d0
	move	d5,d1
	cmp	#5,d1
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86s P96 off enemy reflections earlier fade active',10
