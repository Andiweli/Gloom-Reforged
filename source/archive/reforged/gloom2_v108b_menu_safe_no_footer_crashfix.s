...
.loop	jsr	selmenu
	move	d0,d7
	and	#$0300,d7	;v108: $0100=left, $0200=right in game menu
	and	#$00ff,d0
	tst	d7
...
.game_menu_adjust
	cmp	#2,d0
	bne.s	.notpsize
	bra	.loop		;resolution row kept for visual parity
.notpsize
	cmp	#3,d0
	bne.s	.notwsize
	bsr	newwsize
...
gamemenu	dc.b	14
	dc.b	'CONTINUE',0
	dc.b	92,0
	; label columns padded so ':' lines up, from last gloom.s menu layout
game_res	dc.b	'              RESOLUTION: NATIVE                ',0
...
trainer_txt_custom	dc.b	'CUSTOM',0
...
.encode	lea	joyx(pc),a0
	...
	rts
.normal_menu_mask	and	#$1c,d0	;fire/up/down only!
	rts
