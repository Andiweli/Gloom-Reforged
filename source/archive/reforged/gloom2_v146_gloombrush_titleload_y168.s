...
dointro	;
	...
	bsr	chaton
	;
	; v146: pics/gloom is already visible on the initial title screen.
	; Keep ABOUT clean, and redraw the overlay again when the actual menu
	; is rebuilt after returning from ABOUT or other title transitions.
	jsr	inputon
	jsr	waitany
	;
.redrawmenu
