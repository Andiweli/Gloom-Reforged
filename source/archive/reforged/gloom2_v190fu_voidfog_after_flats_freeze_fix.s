...
drawscene	;a5=player
	...
	jsr	g2log_drawstep
	; v190fu: do not fill void fog before roof/floor on real Amiga.
	; v190bb moved this call here; that can freeze the game task when walking.
	; The actual void-fog fill is now done after flats again, like v190ba.
	;
	move	roofflag(pc),d0
...
.g2v190dm_floor_fog
	...
	jsr	g2fill_disabled_flat_fog
.nofloor	;
	; v190fu: safe v190ba order - fill void/far corridor fog only after
	; walls and flats, so non-zero fog pixels cannot block floor/ceiling draws.
	jsr	g2fill_void_fog
