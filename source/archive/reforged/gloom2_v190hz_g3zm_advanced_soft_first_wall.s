...
.scdone	move.l	d0,d1
	...
	cmp	#2,g2_game_profile	; v190hz: G3/ZM soft first wall entry in ADVANCED
	beq.s	.g2v190hz_wallclip_profile
	cmp	#3,g2_game_profile
	bne.s	.g2v190dz_wallclip_done
.g2v190hz_wallclip_profile
	cmp	#(14<<grdshft),d2	; only the final 14..16 width band dissolves in
	blo.s	.g2v190dz_wallclip_done
	move	#g2advviewfar,d6
	sub	d2,d6
	lsr	#5,d6	; 0..16 visible Bayer amount over 14..16 widths
	cmp	#16,d6
	bls.s	.g2v190hz_wallclip_lvl_ok
	moveq	#16,d6
.g2v190hz_wallclip_lvl_ok
	move	d2,d5
	lsr	#8,d5
	and	#3,d5
	lsl	#2,d5
...
.g2v190dw_wall_shade_ok
	...
	tst	g2_visibility
	; v190hy: profiles 2/3 now use exactly the same confirmed ADVANCED
	; smooth fog path as Gloom/Gloom Deluxe.  No separate G3/ZM far-wall
	; dither/clamp branch here.
...
.g2v190dw_shapelist_view_ok
	...
	cmp	#2,g2_game_profile	; v190hz: G3/ZM strip/object soft first entry in ADVANCED
	beq.s	.g2v190hz_shapeclip_profile
	cmp	#3,g2_game_profile
	bne.s	.g2v190dz_shapeclip_done
.g2v190hz_shapeclip_profile
	cmp	#(14<<grdshft),d1	; only the final 14..16 width band dissolves in
	blo.s	.g2v190dz_shapeclip_done
	move	#g2advshapez,d6
	sub	d1,d6
	lsr	#5,d6	; 0..16 visible Bayer amount over 14..16 widths
	cmp	#16,d6
	bls.s	.g2v190hz_shapeclip_lvl_ok
	moveq	#16,d6
.g2v190hz_shapeclip_lvl_ok
	move	d1,d5
	lsr	#8,d5
	and	#3,d5
	lsl	#2,d5
