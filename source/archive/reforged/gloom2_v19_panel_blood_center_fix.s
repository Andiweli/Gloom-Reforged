...
blitscene	;
	...
	;
	;v19: keep the 224..239 HUD/gun panel valid in both draw buffers.
	;Original gloom2 only refreshed it on ob_update, leaving stale/pixelmüll
	;in the lower playfield on the OS/NewMode C2P path.
	bclr	#7,ob_update(a5)
	bsr	showstats
	move	#2,panelcnt
	rts
...
newscreen	dc	48,0	;x,y ;v19: stronger WinUAE right-centering nudge
