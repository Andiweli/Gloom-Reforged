...
solidstrip	set	0
drawstrip2	; v190 chunky-safe transparent wall strip overlay
	; a1=top of destination column, a2=palettes base, a4=strip/vd data
	; This replaces the disabled legacy planar drawstrip_ path.  Non-zero
	; texels are drawn through the current wall palette, zero texels leave the
	; already-rendered scene/floor behind untouched.
	movem.l	d0-d7/a0-a5,-(a7)
...
.g2v190f_shifted_newgame
	...
	bra	.newgame
.g2v190f_level_lrsel	cmp	#$0100,d7
	beq.s	.g2v190f_level_prev
	bsr	g2v190f_level_next
	bra	.g2v190f_redraw_after_level_change
.g2v190f_level_prev	bsr	g2v190f_level_prev
.g2v190f_redraw_after_level_change
...
startmenu	dc.b	13
	dc.b	'START LEVEL ['
g2v190f_level_text	dc.b	'MAP1_1',']',0	;0 v190f direct map test selector
...
g2v190f_level_next
	...
	cmp	#g2v190f_level_count,d0
	bcs.s	g2v190f_level_update
	clr	g2v190f_level_index
	bra.s	g2v190f_level_update

g2v190f_level_prev
	tst	g2v190f_level_index
	bne.s	.prevok
	move	#g2v190f_level_count-1,g2v190f_level_index
	bra.s	g2v190f_level_update
.prevok	subq	#1,g2v190f_level_index
	bra.s	g2v190f_level_update

g2v190f_level_update
	movem.l	d0-d1/a0-a1,-(a7)
	move	g2v190f_level_index(pc),d0
	lea	g2v190f_level_name_table(pc),a0
	move.l	0(a0,d0*4),a0
...
g2v190f_level_start
	movem.l	d0/a0,-(a7)
	bsr.s	g2v190f_level_update
	move	g2v190f_level_index(pc),d0
	lea	g2v190f_level_path_table(pc),a0
	move.l	0(a0,d0*4),d0
	move.l	d0,map_test
	movem.l	(a7)+,d0/a0
	rts

g2v190f_level_count	equ	16

g2v190f_level_name_table
	dc.l	g2v190f_map1_1_name,g2v190f_map1_2_name,g2v190f_map1_3_name,g2v190f_map1_4_name
	dc.l	g2v190f_map1_5_name,g2v190f_map1_6_name,g2v190f_map1_7_name,g2v190f_map1_8_name
	dc.l	g2v190f_map2_1_name,g2v190f_map2_2_name,g2v190f_map2_3_name,g2v190f_map2_4_name
	dc.l	g2v190f_map2_5_name,g2v190f_map2_6_name,g2v190f_map2_7_name,g2v190f_map2_8_name

g2v190f_level_path_table
	dc.l	g2v190f_map1_1_path,g2v190f_map1_2_path,g2v190f_map1_3_path,g2v190f_map1_4_path
	dc.l	g2v190f_map1_5_path,g2v190f_map1_6_path,g2v190f_map1_7_path,g2v190f_map1_8_path
	dc.l	g2v190f_map2_1_path,g2v190f_map2_2_path,g2v190f_map2_3_path,g2v190f_map2_4_path
	dc.l	g2v190f_map2_5_path,g2v190f_map2_6_path,g2v190f_map2_7_path,g2v190f_map2_8_path

g2v190f_map1_1_name	dc.b	'MAP1_1',0
g2v190f_map1_2_name	dc.b	'MAP1_2',0
g2v190f_map1_3_name	dc.b	'MAP1_3',0
g2v190f_map1_4_name	dc.b	'MAP1_4',0
g2v190f_map1_5_name	dc.b	'MAP1_5',0
g2v190f_map1_6_name	dc.b	'MAP1_6',0
g2v190f_map1_7_name	dc.b	'MAP1_7',0
g2v190f_map1_8_name	dc.b	'MAP1_8',0
g2v190f_map2_1_name	dc.b	'MAP2_1',0
g2v190f_map2_2_name	dc.b	'MAP2_2',0
g2v190f_map2_3_name	dc.b	'MAP2_3',0
g2v190f_map2_4_name	dc.b	'MAP2_4',0
g2v190f_map2_5_name	dc.b	'MAP2_5',0
g2v190f_map2_6_name	dc.b	'MAP2_6',0
g2v190f_map2_7_name	dc.b	'MAP2_7',0
g2v190f_map2_8_name	dc.b	'MAP2_8',0
	even
g2v190f_map1_1_path	dc.b	'maps/map1_1',0
g2v190f_map1_2_path	dc.b	'maps/map1_2',0
g2v190f_map1_3_path	dc.b	'maps/map1_3',0
g2v190f_map1_4_path	dc.b	'maps/map1_4',0
g2v190f_map1_5_path	dc.b	'maps/map1_5',0
g2v190f_map1_6_path	dc.b	'maps/map1_6',0
g2v190f_map1_7_path	dc.b	'maps/map1_7',0
g2v190f_map1_8_path	dc.b	'maps/map1_8',0
g2v190f_map2_1_path	dc.b	'maps/map2_1',0
g2v190f_map2_2_path	dc.b	'maps/map2_2',0
g2v190f_map2_3_path	dc.b	'maps/map2_3',0
g2v190f_map2_4_path	dc.b	'maps/map2_4',0
g2v190f_map2_5_path	dc.b	'maps/map2_5',0
g2v190f_map2_6_path	dc.b	'maps/map2_6',0
g2v190f_map2_7_path	dc.b	'maps/map2_7',0
g2v190f_map2_8_path	dc.b	'maps/map2_8',0
	even
