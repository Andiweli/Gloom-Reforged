...
dogamemenu	;
	...
	; v190ae: use the black quick-menu background for the in-game menu.
	; bigfont2 needs its yellow palette entries, but poking those colours while
	; the live game view is visible recolours wall pixels in episode 2/3.
	; Drawing the game menu on a black screen keeps the yellow menu text without
	; exposing the temporary font palette over the playfield.
	lea	gamemenu,a0
	jsr	qmenu
