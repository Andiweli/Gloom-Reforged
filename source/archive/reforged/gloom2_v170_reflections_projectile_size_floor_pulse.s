...
g2_prepare_reflection_column
	...
	move	d3,d0
	lsr	#2,d0	;floor pickup ring base: stable and modest
	cmp	#5,d0
	bge	.up_min_ok
	moveq	#5,d0
.up_min_ok
	...
	moveq	#16,d0
.pick_pulse
	; v170: pickups do not follow their vertical bob.  They stay at a fixed
	; floor anchor and only pulse a little near the low/touch part of the
	; animation.  For the bouncy pickup, frame 3 is the low frame used twice
	; in its 3,4,3,5 loop.  Other stationary token pickups get a very small
	; phase pulse from their spawn delay, without changing the floor anchor.
