...
g2draw_statusbar_char	;d0.b=character, d7.w=x
	...
	moveq	#3,d1		;v57: two pixels higher than v56 (224+3)
	bsr	drawchunky
.g2smc_rts
	rts
...
g2v57_clear_title_bottomline	;clear stale line below 200px title picture in both compact OS bitmaps
	movem.l	d0-d7/a0-a2,-(a7)
	move.l	bitmaps,d0
	beq.s	.rts
	move.l	d0,a0
...
.clearone	movem.l	a0-a1,-(a7)
	...
	movem.l	(a7)+,a0-a1
	rts
.clearone_a0	; clear lines 200-203 over all active bitplanes
	move	bitplanes(pc),d7
	beq.s	.cdone
	subq	#1,d7
	move.l	bpmod(pc),d6
...
dointro	;
	...
	jsr	g2v57_clear_title_bottomline	;v57: remove stale line below title image
