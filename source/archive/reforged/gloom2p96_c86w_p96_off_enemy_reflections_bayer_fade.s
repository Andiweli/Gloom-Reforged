	...
	;gloom2p96_c86w: enemy reflections Bayer fade without vertical streaks.
	;
...
.yloop
	cmp.l	a1,a0
	bhi	.rts
	; c86w: 4x4 ordered fade.  c86v removed the diagonal phase but
	; became column-stable, causing vertical streaks.  This keeps the
	; reflected sprite pixels themselves, but gates them through a small
	; Bayer pattern: dense near the feet, coarser and more transparent
	; toward the lower fade end.
	moveq	#12,d4		; top: 12/16 pixels kept
	cmp	#3,d5
	blt.s	.dither_pick
	moveq	#8,d4		; middle: 8/16 pixels kept
	cmp	#9,d5
	blt.s	.dither_pick
	moveq	#4,d4		; lower: 4/16 pixels kept
	cmp	#15,d5
	blt.s	.dither_pick
	moveq	#2,d4		; tail: 2/16 pixels kept
.dither_pick
	move	g2_enemy_ref_curx(pc),d0
	and	#3,d0
	move	d5,d1
...
; c86w 4x4 ordered threshold table for enemy-reflection transparency.
g2_enemy_ref_bayer4
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86w P96 off enemy reflections Bayer fade active',10
