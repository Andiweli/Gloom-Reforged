...
g2deffogfar	equ	8<<grdshft	; v190fp/v190fc: shared darktable cap; DEFAULT keeps original range, ADVANCED scales to it
g2advviewfar	equ	16<<grdshft	; v190fp/v190fc: ADVANCED actual view/fog range = 16 texture widths
g2advshapez	equ	16<<grdshft	; v190fp/v190fc: ADVANCED strips/objects match the 16-width range
	;
exshft	equ	3
exone	equ	1<<exshft
exhalf	equ	exone>>1
...
dothezone2	;
	...
	move	#g2advviewfar,d4	; v190fp/v190fc: ADVANCED zone/wall cull = 16 texture widths
...
.noov	lsr	#1,d0	;fraction -> unsigned
	...
	move	#(g2advviewfar<<exshft)-8,d6	; v190fp/v190fc: ADVANCED wall cast just below signed 16-bit edge, approx 16 widths
...
g2_visibility	dc	-1	;v190fp -1=DEFAULT, +1=ADVANCED(16); saved in gloom.cfg
