...
.g2v190dy_wallfade_done
	; v190eh: Bayer shade-blend between neighbouring fog palettes.
	; Do not dither geometry or clipping here: the wall/door column stays
	; present, but near a fog-step boundary some columns use the next darker
	; palette.  This softens visible distance bands without creating holes.
	cmp	#14,d3
	bcc.s	.g2v190eh_wallblend_done
	move	d2,d6
	tst	g2_visibility
	ble.s	.g2v190eh_wallblend_dist_ok
	lsr	#1,d6
.g2v190eh_wallblend_dist_ok
	cmp	#(2<<grdshft),d6
	blo.s	.g2v190eh_wallblend_done
	move	d6,d5
	and	#$3f,d5
	lsr	#2,d5	; 0..15 blend amount within this fog slice
	beq.s	.g2v190eh_wallblend_done
	move	d6,d4
	lsr	#6,d4
	and	#3,d4
	lsl	#2,d4
	...
	addq	#1,d3
	cmp	#14,d3
	bls.s	.g2v190eh_wallblend_done
	moveq	#14,d3
.g2v190eh_wallblend_done
	movem	d2-d3,vd_z(a0)
	;
	move	#-256,d3
	sub	camy(pc),d3
...
g2_visibility	dc	-1	;v190ec -1=DEFAULT, +1=ADVANCED; saved in gloom.cfg
