...
.moloop	move.b	(a0)+,(a1)+
	bne.s	.moloop
	bra	.sel
.notvile	cmp	#9,d0		;v113 compact title menu ABOUT index
	bne	.notabout
	;
.about	;about text...
	;
...
.noch	move	(a7)+,numopts
	...
	bra	dointro
	;
.notabout	cmp	#10,d0		;v113 compact title menu EXIT index
	bne	.sel
	;
...
startmenu	dc.b	11			;v113: compact/stable title menu, EXIT visible
...
p1ctype
	...
	dc.b	'CD32 PAD 1',0	;4
	elseif
	dc.b	'KEYBMOUSE  ',0	;4 v113 fixed 10-char slot
	endc
	;
	dc.b	'PLAYER 2 '
p2ctype
	...
	dc.b	'CD32 PAD 2',0	;5
	elseif
	dc.b	'JOYSTICK 1',0	;5 v113 PLAYER 2 default
	endc
	;
	dc.b	92,0			;6 spacer
