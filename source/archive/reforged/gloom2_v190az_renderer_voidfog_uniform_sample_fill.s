...
drawscene	;a5=player
	...
	jsr	g2log_drawstep
	; v190ax: apply far-corridor fog immediately after wall rendering.
	; This keeps distant corridor openings dark like neighbouring walls,
	; while floor/ceiling and later sprites/effects render over it normally.
	jsr	g2fill_void_fog
	;
	move	roofflag(pc),d0
	ble.s	.noroof
