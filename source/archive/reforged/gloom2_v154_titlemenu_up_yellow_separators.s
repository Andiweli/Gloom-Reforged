...
; v154: draw two thin 80px yellow separators into the blank title-menu rows:
; one between TWO PLAYER COMBAT and PLAYER 1, one between PLAYER 2 and
; REMOTE LINK OPTIONS.  The title menu palette is still active here, so
; colour index 3 is the same yellow as the menu font.
