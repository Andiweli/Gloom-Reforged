...
; v142/v145: safe main-menu gloombrush overlay.
...
dointro	;
	...
	bsr	chaton
	;
	; v145: keep the plain title screen clean until fire/key is pressed.
	; The pics/gloom logo is overlaid only when the actual menu is built,
	; and it starts 168 pixels down from the top of the title bitmap.
	jsr	inputon
	jsr	waitany
	;
.redrawmenu
