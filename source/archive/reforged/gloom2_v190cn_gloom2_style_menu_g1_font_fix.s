...
dointro	;
	; v190cn: use the original v190cf/Gloom2 title-menu row layout for all profiles.
	jsr	g2v145_show_clean_title
	bsr	dispon
	jsr	g2v145_draw_menu_gloombrush
	;
	...
	jsr	inputon
	tst	g2_game_profile	; v190cn: compatibility profiles go straight to the Gloom2-style menu
...
; Gloom original: old font/menu layout.  No pics/title and no pics/gloom are loaded;
; the title/menu background is pics/blackmagic and fonts use misc/bigfont.bin/smallfont.bin.
