...
g2deffogfar	equ	8<<grdshft	; v190fr/v190ey: shared darktable cap used by confirmed smooth ADVANCED path
g2advviewfar	equ	12<<grdshft	; v190fr/v190ey: ADVANCED actual view/fog range = 12 texture widths
g2advshapez	equ	12<<grdshft	; v190fr/v190ey: ADVANCED strips/objects match the 12-width range
	;
exshft	equ	3
exone	equ	1<<exshft
exhalf	equ	exone>>1
...
dothezone2	;
	...
	move	#g2advviewfar,d4	; v190fr/v190ey: ADVANCED zone/wall cull = 12 texture widths
...
.noov	lsr	#1,d0	;fraction -> unsigned
	...
	move	#g2advviewfar<<exshft,d6	; v190fr/v190ey: ADVANCED wall cast = 12 texture widths
...
.rite	add.l	playerxa(pc),d0
	...
	moveq	#32,d0
	moveq	#0,d1
	jmp	playsfx	; v190fr buildfix: same tail-call as bra playsfx, but GenAm range-safe
	;
.nofire	clr	deflbut
.rts	rts
...
g2_visibility	dc	-1	;v190fr -1=DEFAULT, +1=ADVANCED(12); saved in gloom.cfg
