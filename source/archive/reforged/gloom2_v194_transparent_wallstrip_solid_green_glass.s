...
solidstrip	set	0
drawstrip2	; v194 chunky-safe transparent wall strip overlay with solid green glass tint
	...
	; texels are filled with a continuous darker green glass colour so the
	; door gaps read as solid green-translucent panels instead of striped
	; checker gaps.
	movem.l	d0-d7/a0-a5,-(a7)
...
.glass	tst	d6
	bmi.s	.next
	move.b	d6,(a1)		; v194: solid green glass fill for every transparent texel
.next	addx.l	d3,d0
	add.l	d7,a1
	dbf	d4,.loop
