...
.g2dg_have_shape_index
	lsl	#2,d6
	addq	#12,d6		;anim offset table entry
	move.l	0(a0,d6.w),d0
	beq.w	.g2dg_done
	cmp.l	#$20000,d0
	bcc.w	.g2dg_done
	...
	add	#10,d4		;v68: firing recoil, push weapon back/down
.g2dg_no_recoil_y
	;
...
.g2dm_shape_ok
	...
	move	6(a0),d3		;height
	move	#240,d4
	sub	d3,d4		;ZGloom muzzle base: bottom-aligned, before gun recoil
	bsr	g2drawgun_coloffs_shape
.g2dm_done
	movem.l	(a7)+,d0-d7/a0-a5
	rts
...
.nomega	bsr	shoot
	;
.shdone	move.l	(a7)+,a0
	move	#10,g2gun_firetimer	;v68 ZGloom-style fired/recoil timer
	move.l	(a0),a0
	moveq	#32,d0
	moveq	#0,d1
	bsr	playsfx
