...
solidstrip	set	0
drawstrip2	; v190a chunky-safe transparent wall strip overlay crashfix
...
.hiteok
	...
	sub	d3,d0
	add.l	d3,d0
	moveq	#0,d5		; v190a: keep palette table index clean
	move	vd_pal(a4),d5
	move.l	0(a2,d5*4),a5
.loop
	moveq	#0,d5		; v190a: keep texel LUT index clean, avoids map1_4 crash
	move.b	0(a0,d0),d5
	beq.s	.skip
	move.b	0(a5,d5.w),(a1)
.skip	addx.l	d3,d0
