...
.redrawmenu
	...
	; v190hd: one shared local title menu for every profile.
	; Gloom, Gloom Deluxe, Gloom3 and Zombie Massacre all use the proven
	; Deluxe START LEVEL layout and the same index mapping.
	lea	startmenu,a4
	jsr	initmenu
...
.notlinked
	...
	and	#$00ff,d0
	; v190hd: one shared menu mapping for all local profiles.
	; Old compat handlers remain below but are no longer reached from title menu.
	tst	d7
