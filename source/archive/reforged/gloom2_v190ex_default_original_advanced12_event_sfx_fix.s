...
g2advviewfar	equ	12<<grdshft	; v190ex: ADVANCED uses the confirmed 12-texture-width view/fog range
g2advshapez	equ	12<<grdshft	; v190ex: ADVANCED strips/objects match the 12-width range
	;
exshft	equ	3
exone	equ	1<<exshft
exhalf	equ	exone>>1
...
.g2v190dw_flat_far
	cmp	#g2advviewfar,d6	; v190ex: ADVANCED = confirmed 12 texture widths
	bcc	.rts
	move	d6,d5
	lsr	#1,d5	; v190ex: 12 actual widths map to the original 6-width fog cap
.g2v190dw_flat_shade
	;
...
.g2v190dw_blood_far
	cmp	#g2advviewfar,d2	; v190ex: ADVANCED = 12 texture widths
	bcc	.loop
.g2v190dw_blood_zok
	;
	ext.l	d0
...
.g2v190dw_shape_far
	cmp	#g2advshapez,d2	; v190ex: ADVANCED objects/sprites = 12 texture widths
	bcc	.rts
.g2v190dw_shape_zok
	;
	muls	cm1(pc),d0
...
dothezone2	;
	...
	move	#g2advviewfar,d4	; v190ex: ADVANCED zone cull = 12 texture widths
...
.zok	;
	...
	move	#g2advviewfar,d4	; v190ex: ADVANCED wall/zone cull = 12 texture widths
...
.noov	lsr	#1,d0	;fraction -> unsigned
	...
	move	#g2advviewfar<<exshft,d6	; v190ex: ADVANCED wall cast = 12 texture widths
...
.drawloop	move.l	(a6),d0
	...
	move	#g2advshapez,d0	; v190ex: ADVANCED strips/objects = 12 texture widths
