...
g2_prepare_reflection_column
	...
	; v169: keep v138 projectile behaviour, but classify known stationary
	; pickups separately so they get a small floor reflection without importing
	; the unstable v139/v139a exit-crash experiment wholesale.
	cmp	#3<<grdshft,d2
	bgt	.no_reflect
	move	d7,g2_shadow_curx
	move	d7,d0
...
.bul_min_ok
	...
	moveq	#10,d0
.rx_ok
	; Pickups pulse on the floor instead of following the bobbing sprite.
...
.store_rx	move	d0,g2_shadow_rx
	...
	; use the opposite sign and a wider clamp so their floor ring stays put
	; while the sprite bobs.
	clr	g2_shadow_yoff
	tst	g2_reflect_pickup
	bne	.pickup_ycalc
	move	ob_y(a2),d0
