...
.gotdata	;
	...
	;combat type game!
	;
	lea	g2combat_stage_init,a0
	move.l	#g2combat_stage_init_len,d3
...
.play	add	#49,d0
	...
	lea	g2combat_stage_menu_selected,a0
	move.l	#g2combat_stage_menu_selected_len,d3
	jsr	g2combat_stage_log
	;
	bsr	finitqmenu
	move.b	comnum(pc),d0
	...
	move	d0,p2lives
	;
	lea	g2combat_stage_files_begin,a0
	move.l	#g2combat_stage_files_begin_len,d3
	jsr	g2combat_stage_log
	lea	combatfiles(pc),a0
	bsr	permit
	bsr	loadfiles
	lea	g2combat_stage_files_done,a0
	move.l	#g2combat_stage_files_done_len,d3
	jsr	g2combat_stage_log
	bra	forbid
normalgame	;
...
pickcombat	;pick combat zone...
	;put name into a1...
	;
	lea	g2combat_stage_pick_enter,a0
	move.l	#g2combat_stage_pick_enter_len,d3
	jsr	g2combat_stage_log
	move.l	a1,-(a7)
	;
	tst	linked
...
.loop	move.b	(a0)+,(a1)+
	bne.s	.loop
	;
	lea	g2combat_stage_showpic_begin,a0
	move.l	#g2combat_stage_showpic_begin_len,d3
	jsr	g2combat_stage_log
	move.l	combat,a0
	move.l	combatpal,a1
	jsr	showpic
	lea	g2combat_stage_showpic_done,a0
	move.l	#g2combat_stage_showpic_done_len,d3
	jsr	g2combat_stage_log
	bsr	g2waitfreshany	; c86zcn: wait for a new Fire/Return before loading combat map
	lea	g2combat_stage_loadtile_begin,a0
	move.l	#g2combat_stage_loadtile_begin_len,d3
	jsr	g2combat_stage_log
...
scriptplay	;
	...
	;
	lea	g2combat_stage_scriptplay,a0
	move.l	#g2combat_stage_scriptplay_len,d3
	jsr	g2combat_stage_log
	bsr	pickcombat
...
.p2	;
	bsr	permit
	;
	; c86zcr: logger-safe map load.
	; The logger uses a0 for the stage string, so set the real
	; map path AFTER logging, and test map_map AFTER the done-log.
	lea	g2combat_stage_mapload_begin,a0
	move.l	#g2combat_stage_mapload_begin_len,d3
	jsr	g2combat_stage_log
	move.l	map_test(pc),d0
	bne.s	g2zcr_use_maptest
	move.l	#mappath,d0
g2zcr_use_maptest
	move.l	d0,a0
	moveq	#1,d1
...
.nolmed	;
	...
	clr	framecnt
	clr	paused
	lea	g2combat_stage_predraw_begin,a0
	move.l	#g2combat_stage_predraw_begin_len,d3
	jsr	g2combat_stage_log
	jsr	predrawall
	lea	g2combat_stage_predraw_done,a0
	move.l	#g2combat_stage_predraw_done_len,d3
	jsr	g2combat_stage_log
	bsr	dispon
	bsr	chaton
	lea	g2combat_stage_mainloop,a0
	move.l	#g2combat_stage_mainloop_len,d3
	jsr	g2combat_stage_log
	;
...
.g2no_tele_black_hold
	...
	beq	mainloop
	;
mainexit	lea	g2combat_stage_mainexit,a0
	move.l	#g2combat_stage_mainexit_len,d3
	jsr	g2combat_stage_log
	st	paused
	bsr	chatoff
	bsr	dispoff
...
exitgame	cmp	#2,gametype
	bne.s	gameover
combatover	lea	g2combat_stage_combatover,a0
	move.l	#g2combat_stage_combatover_len,d3
	jsr	g2combat_stage_log
	move.l	combat,a1
	freemem	combat
	move.l	combatpal,a1
...
; c86zcp: minimal TWO PLAYER COMBAT stage logger.  It overwrites
; DH3:gloom_combat_stage.txt with the latest reached stage.  This is
; diagnostic only and intentionally does not try to fix the crash.
; Call with a0 = message, d3 = message length.
...
g2combat_log_name	dc.b	'DH3:gloom_combat_stage.txt',0
	even
g2combat_stage_init	dc.b	'COMBAT: initnewgame combat branch',10
g2combat_stage_init_len	equ	*-g2combat_stage_init
g2combat_stage_menu_selected	dc.b	'COMBAT: combat menu selected',10
g2combat_stage_menu_selected_len	equ	*-g2combat_stage_menu_selected
g2combat_stage_files_begin	dc.b	'COMBAT: combat files load begin',10
g2combat_stage_files_begin_len	equ	*-g2combat_stage_files_begin
g2combat_stage_files_done	dc.b	'COMBAT: combat files load done',10
g2combat_stage_files_done_len	equ	*-g2combat_stage_files_done
g2combat_stage_scriptplay	dc.b	'COMBAT: scriptplay combat branch',10
g2combat_stage_scriptplay_len	equ	*-g2combat_stage_scriptplay
g2combat_stage_pick_enter	dc.b	'COMBAT: pickcombat enter',10
g2combat_stage_pick_enter_len	equ	*-g2combat_stage_pick_enter
g2combat_stage_showpic_begin	dc.b	'COMBAT: showpic begin',10
g2combat_stage_showpic_begin_len	equ	*-g2combat_stage_showpic_begin
g2combat_stage_showpic_done	dc.b	'COMBAT: showpic done',10
g2combat_stage_showpic_done_len	equ	*-g2combat_stage_showpic_done
g2combat_stage_loadtile_begin	dc.b	'COMBAT: loadtile begin',10
g2combat_stage_loadtile_begin_len	equ	*-g2combat_stage_loadtile_begin
...
g2combat_stage_predraw_begin	dc.b	'COMBAT: predrawall begin',10
g2combat_stage_predraw_begin_len	equ	*-g2combat_stage_predraw_begin
g2combat_stage_predraw_done	dc.b	'COMBAT: predrawall done',10
g2combat_stage_predraw_done_len	equ	*-g2combat_stage_predraw_done
g2combat_stage_mainloop	dc.b	'COMBAT: mainloop reached',10
g2combat_stage_mainloop_len	equ	*-g2combat_stage_mainloop
g2combat_stage_mainexit	dc.b	'COMBAT: mainexit reached',10
g2combat_stage_mainexit_len	equ	*-g2combat_stage_mainexit
g2combat_stage_combatover	dc.b	'COMBAT: combatover reached',10
g2combat_stage_combatover_len	equ	*-g2combat_stage_combatover
	even
