...
scriptplay	;
	...
	;
.notcombat	;
	; v190s: Levelselect must not jump directly to the selected play_ line,
	; because tile_ commands before the map set up floor/ceiling textures.
	; Instead the script starts at the beginning, and earlier play_ commands
	; are skipped until the selected play_ offset is reached.  Non-play setup
	; commands, especially tile_, still execute normally.
	move.l	g2v190i_start_offset(pc),d7
	bmi.s	.g2v190s_noskip
	move.l	scriptat(pc),d0
	sub.l	script(pc),d0
	subq.l	#5,d0		; scriptat points after "play_" here -> command start offset
	cmp.l	d7,d0
	beq.s	.g2v190s_match
...
g2v190f_level_start
	...
	move	g2v190f_level_index(pc),d0
	jsr	g2v190i_get_offset_ptr
	move.l	(a0),g2v190i_start_offset	; v190s: skip earlier play_ commands, keep setup/tile_ commands
...
g2v190i_start_offset dc.l -1	; v190s: selected play_ offset to skip towards, -1 = none
