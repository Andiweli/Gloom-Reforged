	...
	;gloom2p96_c86zc3: full weak reflections with stronger distance-based height build-up and coarser downward fade; c86zb3 enemy coverblock kept.
	;
...
.yloop
	...
	moveq	#5,d4		; top: slightly stronger near the feet
	cmp	#3,d5
	blt.s	.dither_pick
	moveq	#3,d4		; early mid: already weaker
	cmp	#8,d5
	blt.s	.dither_pick
	moveq	#2,d4		; lower: coarse fade
	cmp	#14,d5
	blt.s	.dither_pick
