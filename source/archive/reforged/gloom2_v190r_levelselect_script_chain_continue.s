...
.master	;
	...
	move.l	g2v190i_start_offset(pc),d0	; v190r: START LEVEL enters the real script chain
	bmi.s	.g2v190r_no_levelselect
	add.l	script(pc),d0
	move.l	d0,scriptat
	move.l	#-1,g2v190i_start_offset
	bra	initpstuff		; skip continue menu, then execscript from selected play_ line
...
g2v190f_level_start
	...
	move.l	(a0),g2v190i_start_offset	; v190r: enter normal script chain here
...
g2v190i_start_offset dc.l -1	; v190r: script offset selected by title START LEVEL, -1 = none
