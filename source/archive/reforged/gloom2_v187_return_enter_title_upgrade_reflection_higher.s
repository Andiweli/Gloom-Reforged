...
.rx_ok
	...
	divs	d2,d0
	add	midy(pc),d0
	add	#2,d0		; v187: lift pickup reflections a touch higher again
	cmp	#2,d0
...
checkany	movem.l	d0-d7/a0-a6,-(a7)
	bsr	vwait
	bsr	readmenujoy	; v187: keep joystick/fire support if available
	and	#$10,d0	; fire opens the title menu
	qkey	$44
	beq.s	.noreturn_titlewait
	or	#$10,d0	; RETURN opens the title menu
.noreturn_titlewait
	qkey	$43
