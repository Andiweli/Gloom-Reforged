...
.g2v142_drawone
	movem.l	d0/a0-a1,-(a7)
	move	#168,d0
	cmp	#2,g2_game_profile	; v190dl: Zombie Massacre g3-dc brush 3px higher
...
dointro	;
	cmp	#1,g2_game_profile	; v190dl: original Gloom is handled by separate gloom.s branch
...
g2v190dl_g1_draw_unsupported_text
	...
	move	#104,d6
	jsr	g2v190cv_printmess2_g1_safe
	lea	g2v190dl_msg2,a4
	move	#50,d0
	move	#116,d6
	jsr	g2v190cv_printmess2_g1_safe
	rts

g2v190dl_msg1	dc.b	'Gloom not supported.',0
	even
g2v190dl_msg2	dc.b	'Only for Gloom Deluxe, Gloom3 and Zombie Massacre.',0
	even
