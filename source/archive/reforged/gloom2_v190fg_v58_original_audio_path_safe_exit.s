...
.n22	bsr	g2v190ct_titlefont
	bra	.intro
	;
exittoos	jsr	inputoff	; v190fg: v58-style OS exit path, no recent forced audio/config shutdown
	jsr	freeobjlist2
	jsr	permit
	jsr	finitdisplay
	jsr	finitvbint
...
exec_loop	move	(a6)+,d0
	...
	warn	#$f0f
	;
.rts	tst	doorsfxflag	; v190fg: original v58 event-end door/switch SFX path
	beq.s	.nodoor
	clr	doorsfxflag
...
exec_rotpolys	;
	...
	bra	exec_loop
	;
.ok	st	doorsfxflag	; v190fg: original v58 delayed rot/morph door SFX path
