...
.shdone	move.l	(a7)+,a0
	...
	bsr	playsfx
	;
	; v83: make the already-slower base fire frequency another ~30% slower
	; without changing ob_reload itself, because ob_reload is also used by
	; the weapon/statusbar upgrade display.  Keep upgrade speedups intact by
	; scaling the actual reload counter to about 2.6x ob_reload.
	moveq	#0,d0
