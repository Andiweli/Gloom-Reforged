...
.redrawmenu
	...
	tst	g2_game_profile	; v190hf: Gloom Deluxe keeps original START LEVEL menu
	beq.s	.use_gloom2_startmenu
	lea	compat_startmenu,a4	; v190hf: Gloom/Gloom3/ZM same START LEVEL menu layout
	jsr	initmenu
...
.g2v190i_copy_done
	clr.b	(a1)
	lea	g2v190f_level_text(pc),a0	; v190hf: keep compat START LEVEL text in sync
...
.titlemenu_main	move	#-1,g2v154_titlemenu_lines
	...
	bra.s	.titlemenu_y_done
.titlemenu_compat	move	#-1,g2v154_titlemenu_lines	; v190hf: START LEVEL compat menu uses Deluxe separator rows
