...
.notlinked
	...
	and	#$00ff,d0
	; v190gv: Gloom3/Zombie Massacre use the compact shifted menu mapping.
	cmp	#2,g2_game_profile
...
startmenu_g3zm	dc.b	13		; v190gv: Gloom3/ZM compact text rows, fixed Deluxe separators
	dc.b	'START LEVEL '
g2v190gq_level_text	dc.b	'MAP1.1',0	;0, synced with g2v190f_level_text
	...
	dc.b	0			;4 visual gap, keep real dotted separator lower
	dc.b	0			;5 dotted separator above PLAYER rows, same Y as Gloom Deluxe
	dc.b	'PLAYER 1 '
p1ctypegq
	ifne	cd32
	dc.b	'CD32 PAD 1',0	;6, fixed 10-char field
...
p2ctypegq
	...
	dc.b	'JOYSTICK 1 ',0		;7, fixed 10-char field
	endc
	dc.b	0			;8 dotted separator above REMOTE LINK OPTIONS, same Y as Gloom Deluxe
	dc.b	'REMOTE LINK OPTIONS',0	;9
...
.titlemenu_main	move	#-1,g2v154_titlemenu_lines
	...
	bra.s	.titlemenu_y_done
.titlemenu_g3zm	move	#-1,g2v154_titlemenu_lines	; v190gv: use Deluxe dotted-line Y positions
