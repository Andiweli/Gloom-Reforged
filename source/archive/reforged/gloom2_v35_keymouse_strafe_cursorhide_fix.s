...
.loop	move.l	(a3)+,(a2)+
	...
	st	active
	;
	; v35: hide Intuition mouse pointer while the game/input window is active.
	move.l	oswindow(pc),d0
	beq.s	.nohideptr
	move.l	d0,a0
	lea	g2v35_blank_pointer(pc),a1
	moveq	#1,d0
	moveq	#16,d1
	moveq	#0,d2
	moveq	#0,d3
...
.loop	move.l	a3,(a2)+
	...
	move	#$c000,$dff09a
	;
	; v35: restore normal Intuition pointer when game/input loses focus or exits.
	move.l	oswindow(pc),d0
	beq.s	.noclearptr
	move.l	d0,a0
	move.l	int(pc),a6
