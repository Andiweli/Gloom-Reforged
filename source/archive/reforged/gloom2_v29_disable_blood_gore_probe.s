...
.notinvs	jsr	(a0)
	bra.s	.loop
.done	;
	; v29: temporary blood/gore crash probe - skip body parts lying on ground.
	bra	.done2
	;
	lea	gore(pc),a5
	;
...
.nofloor	;
	...
	jsr	g2log_drawstep
	; v29: temporary blood/gore crash probe - skip blood renderer.
	;bsr	drawblood
...
vbhandler	movem.l	d2-d7/a2-a6,-(a7)
	...
	bsr	dorots
	bsr	dodoors
	; v29: temporary blood/gore crash probe - do not update blood particles.
	;bsr	moveblood
	;
	ifne	debugser
	;
...
bloodymess	;throw random blood splots everywhere!
	; v29: temporary blood/gore crash probe - no blood splats.
	rts
	;
	bsr	bloodspeed2
	add.l	ob_x(a5),d0
...
blowchunx	; v29: temporary blood/gore crash probe - do not spawn body chunks.
	rts
	move	2(a4),d7
	subq	#1,d7
	;
