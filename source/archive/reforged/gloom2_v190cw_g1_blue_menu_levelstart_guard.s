...
g2v142_draw_gloombrush_safe
	...
	; v190ct: Zombie Massacre logo is drawn 1px lower, so only 71 rows remain.
	move	d2,-(a7)
	move	#72,d0
...
.g2v142_drawone
	movem.l	d0/a0-a1,-(a7)
	move	#168,d0
	cmp	#2,g2_game_profile	; v190ct: Zombie Massacre g3-dc brush 1px lower
...
.g2v190cv_clearplanes
	...
	; v190cw: classic Gloom menu text should use the smallfont-style blue,
	; not the previous orange index 6.  After clearing all planes, draw
	; primarily into bitplane 2 -> colour index 4.
	move	bitplanes,d5
	cmp	#3,d5
	bcs.s	.g2v190cw_g1_blue_fallback
	move.l	a1,a2
	add.l	d4,a2
	add.l	d4,a2	; plane 2 = blue-ish title palette entry
	or.b	d0,(a2)
	bra.s	.g2v190cv_nextline
.g2v190cw_g1_blue_fallback
	move.l	a1,a2
	add.l	d4,a2	; very low-plane fallback
	or.b	d0,(a2)
.g2v190cv_nextline
	lea	40(a0),a0
	adda.w	linemodw,a1
