...
compat_startmenu	dc.b	13		; v190co: classic compatibility menu, no START LEVEL
	dc.b	'ONE PLAYER GAME',0	;0
	dc.b	'TWO PLAYER GAME',0	;1
	dc.b	'TWO PLAYER COMBAT',0	;2
	dc.b	92,0			;3 separator above PLAYER rows
	dc.b	'PLAYER 1 '
p1ctypec
	ifne	cd32
...
p2ctypec
	...
	endc
	;
	dc.b	92,0			;6 separator above REMOTE LINK OPTIONS
	dc.b	'REMOTE LINK OPTIONS',0	;7
modetxtc	dc.b	'MEATY VIOLENCE MODE',0	;8
	dc.b	92,0			;9 separator above ABOUT
	dc.b	'ABOUT GLOOM',0		;10
	dc.b	92,0			;11 separator above EXIT
	dc.b	'EXIT GLOOM',0		;12
	even
...
.not_zm
	...
	jsr	g2fileexists
	bne.s	.check_g1
	lea	g2probe_misc_script,a0	; title+script = Gloom Deluxe or Gloom3
	jsr	g2fileexists
	bne.s	.done
