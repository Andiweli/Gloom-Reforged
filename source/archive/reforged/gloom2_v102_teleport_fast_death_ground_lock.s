...
.pixnz	cmp	#12,ob_pixsize(a5)	;v102: finish earlier while visible pixel blocks remain
	...
	; v102: finish teleport noticeably earlier.  This avoids the 1-2 second
	; hold on the final blue pixel screen in the teleport chamber and hands off
	; to the intermission while the pixel/blue transition is still visible.
	clr	ob_pixsize(a5)
	clr	ob_pixsizeadd(a5)
.notpix	;
	move	ob_hyper(a5),d0
