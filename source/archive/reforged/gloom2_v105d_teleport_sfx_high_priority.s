...
dotelesfx	move.l	telesfx(pc),a0
	beq.s	.rts		;v105d: no silent/null sample access if teleport.bin was not loaded
	moveq	#64,d0
	moveq	#80,d1		;v105d: high priority so teleport is not eaten by combat/ambient SFX
	bra	playsfx
.rts	rts
