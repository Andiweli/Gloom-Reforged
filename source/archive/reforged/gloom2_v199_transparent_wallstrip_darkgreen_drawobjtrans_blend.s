...
solidstrip	set	0
drawstrip2	; v199 chunky-safe transparent wall strip overlay with darker true green alpha
	...
	; and avoids the colour/clipping artefacts from the experimental variants.
	movem.l	d0-d7/a0-a5,-(a7)
	move.l	vd_data(a4),d0
	beq	.rts
	move.l	d0,a0		; source texture column
	move	#$0a0,d6		; darker green glass RGB12 tint
	move.l	chunkymod(pc),d7
	move	vd_y(a4),d2
