...
.g2dg_have_shape_index
	...
	add	#6,d4		;v70: shorter firing recoil, push weapon back/down
.g2dg_no_recoil_y
	;
...
.g2dg_bob_done
	...
	; v70: draw muzzle after the gun so it is visible in front of the barrel.
	tst.b	g2gun_recoilflag
	beq.s	.g2dg_done
...
.g2dm_shape_ok
	...
	move	#160,d1
	asr	#1,d0
	sub	d0,d1		;centre muzzle horizontally
	move	6(a0),d3		;height
	move	#208,d4
	sub	d3,d4		;v70: muzzle over barrel, not hidden behind statusbar
	bsr	g2drawgun_coloffs_shape
.g2dm_done
	movem.l	(a7)+,d0-d7/a0-a5
	rts
...
.g2amo_do
	...
	add.l	d2,d2
	add.l	d2,ob_z(a0)
	; v70: raise player projectiles to weapon/muzzle height.
	sub	#48,ob_y(a0)
.g2amo_done
	movem.l	(a7)+,d0-d2/a1
	rts
...
.nomega	bsr	shoot
	;
.shdone	move.l	(a7)+,a0
	move	#3,g2gun_firetimer	;v70: short ZGloom-style fired/recoil timer
	move.l	(a0),a0
	moveq	#32,d0
	moveq	#0,d1
	bsr	playsfx
