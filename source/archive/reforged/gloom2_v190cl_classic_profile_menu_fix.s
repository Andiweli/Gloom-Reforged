...
.redrawmenu
	...
	tst	linked
	bne.s	.g2linkedmenu
	tst	g2_game_profile	; v190cl: classic BM-engine data uses unshifted title menu
	beq.s	.use
	lea	g2compat_startmenu,a4
	bra.s	.use
.g2linkedmenu
	lea	startmenu2,a4
.use	jsr	initmenu
...
.notlinked
	...
	and	#$00ff,d0
	tst	g2_game_profile	; v190cl: Gloom/Gloom3/ZM use classic unshifted rows
