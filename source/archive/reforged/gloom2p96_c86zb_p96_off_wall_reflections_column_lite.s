	...
	;gloom2p96_c86zb: grounded enemy reflections kept; flying enemy reflections off; new per-column wall reflection lite.
	;
...
.col_loop
	...
	cmp	midy(pc),d1
	blt.s	.col_next		; do not mirror rows that never reach the floor half
	move	hite(pc),d2
	sub	#12,d2
	cmp	d2,d1
	bge.s	.col_next		; no room left below wall bottom
