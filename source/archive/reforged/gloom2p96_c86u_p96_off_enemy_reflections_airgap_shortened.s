	...
	;gloom2p96_c86u: enemy reflections exact air-gap with shortened fade length.
	;
...
.yloop
	cmp.l	a1,a0
	bhi	.rts
	; c86t: lighter reflection.  Only the very first rows stay moderately
	; readable; the rest thins out sooner so it does not look too solid.
	move	g2_enemy_ref_curx(pc),d0
	add	d5,d0
	move	d5,d1
	cmp	#3,d1
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86u P96 off enemy reflections airgap shortened active',10
