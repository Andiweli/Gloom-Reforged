...
aga_	equ	-1
os_	equ	-1
g2_no_newmode_extscreen	equ	-1	;v190hw4: use ExtNewScreen + fixed PAL LORES DisplayID to avoid NewMode requester
...
newscreen_v	dc	0	;viewmode
	ifne	g2_no_newmode_extscreen
	dc	$114f	;type: NS_EXTENDED|SCREENQUIET|CUSTOMSCREEN|CUSTOMBITMAP
	elseif
	dc	$4f	;type
	endc
	dc.l	0	;font
	...
	ifne	g2_no_newmode_extscreen
	dc.l	g2_no_newmode_screen_tags	;ExtNewScreen taglist
	endc

	ifne	g2_no_newmode_extscreen
g2_no_newmode_screen_tags
	dc.l	$80000032,$00021000	;SA_DisplayID, PAL LORES_KEY
	dc.l	$80000038,-1		;SA_Quiet, TRUE
	dc.l	$80000036,0		;SA_ShowTitle, FALSE
	dc.l	0,0			;TAG_DONE
	endc
