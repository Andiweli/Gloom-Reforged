...
.loop	move	#maxz-1,d3
	...
	lsr	#5,d3		;v87: use the full 32 shade levels over the shorter Gloom depth
				;range.  v86 used #8 and effectively only gave ~8 levels,
				;which made the scene too bright and banded again.
	cmp	#darkmax,d3
	bls.s	.ok
	move	#darkmax,d3
.ok	move	d3,(a1)+
