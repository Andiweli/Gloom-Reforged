...
.scdone	move.l	d0,d1
	...
	; stable 4x4 Bayer mask from 10..18 texture widths, so geometry
	...
	move	d2,d6
	sub	#(10<<grdshft),d6
	lsr	#7,d6	; 0..16 over the advanced far band
	cmp	#16,d6
...
.g2v190dw_wall_shade_ok
	...
	move	0(a2,d6*2),d3
	; v190dy: ADVANCED keeps the doubled view distance, but the
	; far end now fades over the whole extended range.  This mirrors
	; the DEFAULT behaviour more closely: walls/doors entering at the
	; advanced clip are already darkened and then sparsely dithered
	; towards black instead of popping in as a solid column.
	tst	g2_visibility
	...
	move	d2,d6
	sub	#(10<<grdshft),d6
	lsr	#8,d6	; 0..7 over the 8..16 texture-width advanced band
	add	d6,d3
	cmp	#14,d3
	bls.s	.g2v190dy_wallfade_cap_ok
	moveq	#14,d3
.g2v190dy_wallfade_cap_ok
	cmp	#(14<<grdshft),d2
	blo.s	.g2v190dy_wallfade_done
	move	d2,d6
	sub	#(14<<grdshft),d6
	lsr	#8,d6	; 0..3 over the final 12..16 texture-width band
	move	d7,d0
	and	#3,d0
	cmp	d6,d0
	bge.s	.g2v190dy_wallfade_done
	moveq	#15,d3
...
.g2v190dw_shapelist_view_ok
	...
	; with the same 10..18 texture-width Bayer band as solid walls,
...
g2_visibility	dc	-1	;v190eb -1=DEFAULT, +1=ADVANCED; saved in gloom.cfg
