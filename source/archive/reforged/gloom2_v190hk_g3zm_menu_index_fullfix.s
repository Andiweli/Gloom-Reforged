...
.redrawmenu
	...
	jsr	initmenu
	move	#2,curropt	; v190hk: G3/ZM full-row menu, ONE PLAYER GAME default
	bra.s	.sel
...
.g2compat_g3zm_notlinked
	...
	cmp	#0,d0		; v190hk: START LEVEL left/right
	beq	.g2v190f_level_lrsel
	cmp	#6,d0		; v190hk: PLAYER 1 row in full layout
	beq	.g2compat_g3zm_p1lrsel
	cmp	#7,d0		; v190hk: PLAYER 2 row in full layout
	beq	.g2compat_g3zm_p2lrsel
	bra	.sel
.g2compat_g3zm_fire
	cmp	#0,d0		; v190hk: START LEVEL launch
	beq	.g2v190f_level_start
	cmp	#2,d0
...
compat_startmenu_g3zm	dc.b	13		; v190hk: Gloom3/ZM uses full Deluxe row layout with profile control strings
	dc.b	'START LEVEL '
g2v190hj_level_text	dc.b	'MAP1.1',0	;0 synced from g2v190f_level_text
	dc.b	0			;1 spacer below level selector
	dc.b	'ONE PLAYER GAME',0	;2 default/blinking row
	dc.b	'TWO PLAYER GAME',0	;3
	dc.b	'TWO PLAYER COMBAT',0	;4
	dc.b	0			;5 spacer/dotted line above PLAYER 1
	dc.b	'PLAYER 1 '
...
p2ctypeg3zm
	...
	dc.b	0			;8 spacer/dotted line above REMOTE LINK OPTIONS
	dc.b	'REMOTE LINK OPTIONS',0	;9
modetxtg3zm	dc.b	'MEATY VIOLENCE MODE',0	;10
	dc.b	'ABOUT GLOOM',0		;11
	dc.b	'EXIT GAME',0		;12
	even
...
.titlemenu_compat	move	#-1,g2v154_titlemenu_lines	; v190hf: Classic START LEVEL compat menu uses Deluxe separator rows
	...
	sub	fonth(pc),d6
	bra.s	.titlemenu_y_done
.titlemenu_g3zm	move	#-1,g2v154_titlemenu_lines	; v190hk: G3/ZM full layout uses normal separator rows
	sub	fonth(pc),d6
	sub	fonth(pc),d6
	sub	fonth(pc),d6
.titlemenu_y_done
