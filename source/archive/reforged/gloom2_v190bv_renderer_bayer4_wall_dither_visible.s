...
.hiteok	;
	...
	swap	d3
	subq	#1,d4
	move	d1,g2_dither_botcls
	move	vd_pal(a0),d5	;0...15
	move.l	0(a2,d5*4),a4	;base palette
	move.l	a4,a5			;default alternate = base
	clr.b	g2_dither_thr
	; v190bv: visible 4x4 Bayer-style ordered dither on wall shade bands.
	; For each 64-distance phase, the first ~20 units blend from the
	; lighter side and the last ~20 units blend toward the darker side.
	; This creates a broad transition without spaltenweise wall-table hacks.
	cmp	#1,d5
	blo.s	.g2bd_no_lighter
	move	vd_z(a0),d1
	and	#63,d1
	cmp	#20,d1
	bhs.s	.g2bd_no_lighter
	move	d5,d7
	subq	#1,d7
	move.l	0(a2,d7*4),a5
	moveq	#20,d7
	...
	moveq	#15,d7
.g2bd_lthr_ok
	move.b	d7,g2_dither_thr
	bra.s	.g2bd_setup_done
.g2bd_no_lighter
	cmp	#14,d5
	bhs.s	.g2bd_setup_done
	move	vd_z(a0),d1
	and	#63,d1
	cmp	#44,d1
	blo.s	.g2bd_setup_done
	move	d5,d7
	addq	#1,d7
	move.l	0(a2,d7*4),a5
	sub	#43,d1
	...
	moveq	#15,d1
.g2bd_dthr_ok
	move.b	d1,g2_dither_thr
.g2bd_setup_done
	sub	d3,d2
	add.l	d3,d2
	moveq	#0,d1	; local row phase
	;
...
.g2bd_x0
	...
	addq	#2,d7
.g2bd_x1
	move.b	g2_bayer4(pc,d7.w),d7
	cmp.b	g2_dither_thr(pc),d7
	bcc.s	.g2bd_base
	move.b	0(a5,d5),(a1)
	bra.s	.g2bd_done
.g2bd_base
...
; v190bv wall dither state and 4x4 Bayer matrix.
g2_dither_loopcnt	dc	0
g2_dither_botcls	dc	0
g2_dither_thr	dc.b	0
	even
g2_bayer4	dc.b	0,8,2,10,12,4,14,6,3,11,1,9,15,7,13,5
	even
...
.loop	move.l	(a6)+,a1
	...
	move	width(pc),d6
	subq	#1,d6
	sub	d7,d6	; current screen X for Bayer pattern
	move	d7,g2_dither_loopcnt
	;
	drawsolidstrip
	;
	move	g2_dither_loopcnt(pc),d7
	lea	vd_size(a0),a0
	dbf	d7,.loop
	;
	rts
