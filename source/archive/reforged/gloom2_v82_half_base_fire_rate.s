...
.shdone	move.l	(a7)+,a0
	...
	bsr	playsfx
	;
	; v82: halve the base fire frequency without changing ob_reload itself,
	; because ob_reload is also used by the weapon/statusbar upgrade display.
	; Upgrade boosts still reduce ob_reload, so every boost remains faster.
