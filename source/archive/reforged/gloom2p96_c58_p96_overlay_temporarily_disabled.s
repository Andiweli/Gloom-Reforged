	...
	;gloom2p96_c58: temporarily disable P96 test window/overlay/preview for clean AGA/two-player tests.
	;
...
.waitskip2	; v190hy cleanup: log marker removed
	jsr	doc2p
	jsr	db
	;gloom2p96_c58: P96 overlay/preview temporarily disabled for clean AGA/two-player tests.
...
.osvwait	movem.l	d0-d1/a0-a1/a6,-(a7)
	...
	;gloom2p96_c58: no P96 live preview from vwait while overlay is disabled.
	;jsr	g2p96_preview_frame
	rts
...
.osskipz	;
	...
	;
	;gloom2p96_c58: P96 test overlay is temporarily disabled.
	;Do not allocate preview/RGB staging buffers while testing the restored
	;AGA TWO PLAYER split-screen path.  The P96 routines remain in the file
	;for later reactivation, but all runtime pointers stay null.
	clr.l	p96preview_bufptr
	clr.l	p96preview_rgbptr
	clr.l	p96preview_rgb24lineptr
	clr.l	p96preview_rgb24bottomptr
	clr.l	p96preview_lineptr
	clr.l	p96preview_frameptr
	;
	move.l	#256*16,d0
	moveq	#1,d1
	allocmem	palettes
...
initdisplay	;
	...
	jsr	-408(a6)
	move.l	d0,grbase
	;gloom2p96_c58: skip passive P96 probe while overlay is disabled.
	;jsr	g2p96_probe
	clr	p96present
	clr	p96found
	clr.l	p96base
...
.agasc	move.l	int(pc),a6
	...
	move.l	d0,dbufinfo
	;gloom2p96_c58: do not open the P96 test/preview window.
