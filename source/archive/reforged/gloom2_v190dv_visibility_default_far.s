...
maxz_default	equ	16<<darkshft	;v190dv DEFAULT: original v190du visibility span
maxz_far	equ	32<<darkshft	;v190dv FAR: double visibility span
maxz	equ	maxz_far	;allocate tables for FAR; runtime clips choose DEFAULT/FAR
	;
exshft	equ	3
exone	equ	1<<exshft
exhalf	equ	exone>>1
...
g2_visibility	dc	-1	;v190dv -1=DEFAULT, +1=FAR/double visibility
g2_view_maxz	dc	maxz_default
g2_view_maxz_ex	dc	maxz_default<<exshft
g2_shape_clip_z	dc	6<<grdshft
...
.loop	move	d2,d3
	...
	;
.g2v190aq_farboost
	; v190dv: DEFAULT keeps the confirmed v190du distance fog; FAR doubles
	; the visibility and moves the strong fog ramp outward.
	tst	g2_visibility
	bgt.s	.g2v190dv_far_curve
	move	#(4<<grdshft),d6
	move	#(6<<grdshft),d7
	bra.s	.g2v190dv_curve_ready
.g2v190dv_far_curve
	move	#(8<<grdshft),d6
	move	#(12<<grdshft),d7
.g2v190dv_curve_ready
	cmp	d6,d4
...
.g2v190aq_ramp
	move	d4,d5
	sub	d6,d5
	lsr	#6,d5	; extra darkness before the non-black fog cap
	add	d5,d3
	cmp	#14,d3
...
g2_apply_visibility
	; v190dv: runtime visibility span. DEFAULT preserves the v190du/v190dp
	; distance/fog behaviour; FAR doubles the wall/flat/object span and
	; moves the strong fog ramp outward accordingly.
	tst	g2_visibility
	bgt.s	.far
	move	#maxz_default,g2_view_maxz
	move	#(maxz_default<<exshft),g2_view_maxz_ex
	move	#(6<<grdshft),g2_shape_clip_z
	rts
.far	move	#maxz_far,g2_view_maxz
	move	#$7ff8,g2_view_maxz_ex	; maxz_far<<exshft would be $8000, keep signed cmp safe
	move	#(12<<grdshft),g2_shape_clip_z
	rts
