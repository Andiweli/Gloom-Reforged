...
.loop	move	d2,d3
	lsl	#3,d3
	move	0(a0,d3),d3
	lsr	#2,d3		;v85: one extra depth bit for smoother shade steps
	cmp	#darkmax,d3
	bls.s	.ok
	move	#darkmax,d3
.ok	eor	#darkmax,d3
...
calcpalettes	;v85 generate 32 smoother depth-shaded palettes
	;
	lea	paladjust,a5
...
.loop2	move	(a0)+,d0	;RGB value 0,1,2...
	...
	lsr	#8,d0
	and	#$00f,d0	;R
	add	d0,d0		;v85: work in half-steps for smoother 32-level dimming
	sub	d7,d0
	bgt.s	.rok
	moveq	#2,d0
.rok	lsr	#1,d0
