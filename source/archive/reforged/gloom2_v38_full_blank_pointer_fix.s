...
g2v36_hide_pointer	;force a full-size invisible Intuition pointer for the game window
	movem.l	d0-d3/a0-a1/a6,-(a7)
	move.l	oswindow,d0
	beq.s	.rts
	move.l	int,d1
	...
	beq.s	.rts
	move.l	d0,a0
	moveq	#16,d0	;v38: height 16 lines, not 1-line undersized sprite
	moveq	#16,d1	;width 16 pixels
	moveq	#0,d2	;x offset
	moveq	#0,d3	;y offset
	move.l	int,a6
