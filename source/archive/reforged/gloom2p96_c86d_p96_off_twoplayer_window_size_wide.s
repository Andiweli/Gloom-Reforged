	...
	;gloom2p96_c86d: P96 overlay disabled by default; TWO PLAYER uses dynamic WINDOW SIZE split width.
	;
...
debugser	equ	0
debugmem	equ	0
g2p96_overlay_enabled	equ	0	; c86d: 0 hides/disables P96 overlay, -1 re-enables old c85 P96 preview path
	;
...
g2twop_drawall_split
	...
	;
	jsr	g2twop_prepare_view_width	;c86d: use current WINDOW SIZE width for 2P split
	jsr	g2clearfullchunky	;clear both split halves from the real full-frame base
	jsr	g2twop_center_coloffs	;c86d: center selected split width inside each 320px half
...
g2twop_prepare_view_width
	; c86d: WINDOW SIZE controls the two-player field width again.
...
g2twop_set_half_view
	; c86d: physical split half remains 320x120.  Logical render width follows
	; WINDOW SIZE, while logical render height stays at the full split height.
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c85 safe after rawpen diagnostic active',10
