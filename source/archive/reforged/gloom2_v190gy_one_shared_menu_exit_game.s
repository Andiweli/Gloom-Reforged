...
.redrawmenu
	...
	; v190gy: all local profiles use one identical title menu path and layout.
...
startmenu_g3zm	equ	startmenu	; v190gy: legacy alias, all local profiles use one shared menu
old_startmenu_g3zm	dc.b	12		; legacy data kept only for label/data stability
	dc.b	'START LEVEL '
...
modetxtgq	dc.b	'MEATY VIOLENCE MODE',0	;9
	...
	dc.b	'EXIT GAME',0,0		;11
	even

compat_startmenu	equ	startmenu	; v190gy: legacy alias, all local profiles use one shared menu
old_compat_startmenu	dc.b	11		; legacy data kept only for label/data stability
...
initmenu2	;
	...
	bsr	initfontpal
	; v190gy: absolute single local title-menu safety net.
	; Gloom, Gloom Deluxe, Gloom3 and Zombie Massacre must draw the same
	; startmenu layout. Legacy menu symbols are aliases to startmenu above.
...
.g2v190gt_menu_ok
	...
	; v190gr: startmenu_g3zm is legacy/unused; all local profiles use startmenu.
