...
g2v145_show_clean_title
	move.l	gloom(pc),a0
	move.l	gloompal(pc),a1
	jsr	showpic		; v190k: clear draw bitmap first; avoids stale pink top pixels after game exit
...
.g2v190f_redraw_after_level_change
	...
	jsr	g2v145_show_clean_title	; v190k: rebuild clean title, prevents old/new level text alternating
	bsr	dispon
	bra	.redrawmenu
.g2v190f_level_start
