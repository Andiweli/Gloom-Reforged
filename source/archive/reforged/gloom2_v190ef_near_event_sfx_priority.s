...
exec_loop	move	(a6)+,d0
	...
	warn	#$f0f
	;
.rts	clr	doorsfxflag	; v190ee: door/switch SFX is played immediately once per event
.nodoor	rts
...
exec_changetxt	;
	...
	move	d0,changedtxt
	move.b	d0,zo_t(a1)
	bsr	g2playdoorsfx_once	; v190ee: texture-switch events also click like the old sound path
	bra	exec_loop
...
exec_opendoor	bsr	g2playdoorsfx_once
...
dotelesfx	move.l	telesfx(pc),a0
	moveq	#64,d0
	moveq	#100,d1	; v190ef: teleport is critical, do not let busy channels hide it
	bra	playsfx
