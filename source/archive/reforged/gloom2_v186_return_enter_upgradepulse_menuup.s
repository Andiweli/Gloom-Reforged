...
.rx_ok
	...
	divs	d2,d0
	add	midy(pc),d0
	add	#4,d0		; v186: lift pickup reflections a little higher again
	cmp	#2,d0
...
checkany	movem.l	d0-d7/a0-a6,-(a7)
	bsr	vwait
	bsr	readmenujoy	; v186: do not consume RETURN through unselmenu here
	and	#$10,d0	; fire / RETURN opens the title menu
	qkey	$43
	beq.s	.noenter_titlewait
	or	#$10,d0	; keypad ENTER also opens the title menu
.noenter_titlewait
	qkey	$45
	beq.s	.noesc_titlewait
	or	#$10,d0	; ESC also opens the title menu from the title screen wait
.noesc_titlewait
	movem.l	(a7)+,d0-d7/a0-a6
	rts
