...
.g2v190dw_flat_shade
	...
	move.l	0(a5,d5*4),a5
	; v190ek: symmetric floor/ceiling Bayer blend around each hard
	; shade step.  The near half of a band mixes back to the previous
	; lighter palette, the far half mixes forward to the next darker
	; palette.  Geometry and texture projection stay untouched.
	clr	g2_bayer_thresh
	cmp	#(2<<grdshft),d0
	...
	and	#$3f,d1
	cmp	#32,d1
	blo.s	.g2v190ek_flatblend_lighter
	; far half: current shade fades toward the next darker shade
	cmp	#14,d5
	...
	addq	#1,d1
	cmp	#8,d1
	bls.s	.g2v190ek_flatblend_dark_thresh_ok
	moveq	#8,d1
.g2v190ek_flatblend_dark_thresh_ok
...
.g2v190ek_flatblend_lighter
	; near half: current shade fades back toward the previous lighter shade
	tst	d5
...
.hiteok	;
	...
	move.l	0(a2,d5*4),a4
	; v190ek: dither only the shade-step itself, now symmetrically.
	; The near half of a depth band mixes the current shade with the
	; previous lighter palette, while the far half mixes with the next
	; darker palette.  No wall column or texel is skipped.
	clr	g2_bayer_thresh
	move	vd_z(a0),d6
	tst	g2_visibility
...
.g2v190ej_wallblend_dist_ok
	...
	and	#$3f,d1
	cmp	#32,d1
	blo.s	.g2v190ek_wallblend_lighter
	; far half: current shade fades toward the next darker shade
	cmp	#14,d5
	bcc.s	.g2v190ek_wallblend_restore
	sub	#32,d1
	lsr	#2,d1
	addq	#1,d1
	cmp	#8,d1
	bls.s	.g2v190ek_wallblend_dark_thresh_ok
	moveq	#8,d1
.g2v190ek_wallblend_dark_thresh_ok
	move	d1,g2_bayer_thresh
	addq	#1,d5
	cmp	#14,d5
...
.g2v190ej_wallblend_next_ok
	move.l	0(a2,d5*4),a5
	bra.s	.g2v190ek_wallblend_restore
.g2v190ek_wallblend_lighter
	; near half: current shade fades back toward the previous lighter shade
	tst	d5
	beq.s	.g2v190ek_wallblend_restore
	lsr	#2,d1
	moveq	#8,d7
	sub	d1,d7
...
g2_bayer_thresh	dc	0	;v190ek 0=no blend, 1..8 symmetric shade-step amount
