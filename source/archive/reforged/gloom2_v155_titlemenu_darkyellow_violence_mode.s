...
; v155: draw two thin 80px dark-yellow separators into the blank
...
; Colour index 1 is used for a much darker yellow/brown font-palette tone.
...
.plane	move.l	a1,a2
	...
	add.l	d0,a2
	tst	d2
	beq.s	.darkyellowplane
	moveq	#0,d0
	bra.s	.fill
.darkyellowplane	moveq	#-1,d0
.fill	moveq	#9,d1
.byte	move.b	d0,(a2)+
	dbf	d1,.byte
	addq	#1,d2
