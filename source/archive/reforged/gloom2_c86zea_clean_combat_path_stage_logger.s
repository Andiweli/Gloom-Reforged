...
.gotdata	;
	...
	;combat type game!
	;
	lea	g2zea_stage_initcombat,a0
	move.l	#g2zea_stage_initcombat_len,d3
...
.play	add	#49,d0
	...
	bsr	permit
	bsr	loadfiles
	lea	g2zea_stage_combatfiles,a0
	move.l	#g2zea_stage_combatfiles_len,d3
	jsr	g2combat_stage_log
	bra	forbid
normalgame	;
...
scriptplay	;
	...
	;
	bsr	pickcombat
	lea	g2zea_stage_picktile,a0
	move.l	#g2zea_stage_picktile_len,d3
	jsr	g2combat_stage_log
	bra.s	.gotname
	;
.notcombat	;
...
.g2v22_use_again
	...
	bsr	loadfile
	move.l	d0,map_map
	lea	g2zea_stage_mapload,a0
	move.l	#g2zea_stage_mapload_len,d3
	jsr	g2combat_stage_log
	tst.l	map_map
...
g2v10_map_loaded
	;
	bsr	initmap
	lea	g2zea_stage_initmap,a0
	move.l	#g2zea_stage_initmap_len,d3
	jsr	g2combat_stage_log
	bsr	loadtxts
	lea	g2zea_stage_loadtxts,a0
	move.l	#g2zea_stage_loadtxts_len,d3
	jsr	g2combat_stage_log
	move	#$a3f7,d0
	jsr	seedrnd
	moveq	#1,d0
	jsr	execevent
	lea	g2zea_stage_execevent,a0
	move.l	#g2zea_stage_execevent_len,d3
	jsr	g2combat_stage_log
	tst.l	player1
	beq.s	g2zea_p1_missing
	lea	g2zea_stage_p1ok,a0
	move.l	#g2zea_stage_p1ok_len,d3
	jsr	g2combat_stage_log
	bra.s	g2zea_p1_done
g2zea_p1_missing
	lea	g2zea_stage_p1missing,a0
	move.l	#g2zea_stage_p1missing_len,d3
	jsr	g2combat_stage_log
g2zea_p1_done
	tst.l	player2
	beq.s	g2zea_p2_missing
	lea	g2zea_stage_p2ok,a0
	move.l	#g2zea_stage_p2ok_len,d3
	jsr	g2combat_stage_log
	bra.s	g2zea_p2_done
g2zea_p2_missing
	lea	g2zea_stage_p2missing,a0
	move.l	#g2zea_stage_p2missing_len,d3
	jsr	g2combat_stage_log
g2zea_p2_done
	jsr	g2v190cx_build_g1_tables	; v190cx: synthetic palette/remap for original Gloom
	lea	g2zea_stage_before_forbid,a0
	move.l	#g2zea_stage_before_forbid_len,d3
	jsr	g2combat_stage_log
	bsr	forbid
	lea	g2zea_stage_after_forbid,a0
	move.l	#g2zea_stage_after_forbid_len,d3
	jsr	g2combat_stage_log_protected
	;
...
.g2v190cj_no_game_pal
	bsr	calcpalettes
	bsr	dispoff
	lea	g2zea_stage_paldispoff,a0
	move.l	#g2zea_stage_paldispoff_len,d3
	jsr	g2combat_stage_log_protected
	;
	;
	;init player vars...
...
.p1hok	move	p1health(pc),ob_hitpoints(a5)
	...
	;
.psk	jsr	resetplayer
	lea	g2zea_stage_p1reset,a0
	move.l	#g2zea_stage_p1reset_len,d3
	jsr	g2combat_stage_log_protected
...
.psk2	jsr	resetplayer
	lea	g2zea_stage_p2reset,a0
	move.l	#g2zea_stage_p2reset_len,d3
	jsr	g2combat_stage_log_protected
	jsr	trainer_maintain_one	;v115: apply persistent trainer at level start
.p1	;
	bsr	linkswap
	...
	move	ob_rot(a5),p2r
.shit	;
	lea	g2zea_stage_positions,a0
	move.l	#g2zea_stage_positions_len,d3
	jsr	g2combat_stage_log_protected
	;init windows...
	;
	move.l	loadingmed(pc),d0
...
.nolmed	;
	...
	clr	framecnt
	clr	paused
	lea	g2zea_stage_before_predraw,a0
	move.l	#g2zea_stage_before_predraw_len,d3
	jsr	g2combat_stage_log_protected
	jsr	predrawall
	lea	g2zea_stage_after_predraw,a0
	move.l	#g2zea_stage_after_predraw_len,d3
	jsr	g2combat_stage_log_protected
	bsr	dispon
	bsr	chaton
	lea	g2zea_stage_after_chaton,a0
	move.l	#g2zea_stage_after_chaton_len,d3
	jsr	g2combat_stage_log_protected
	;
...
; c86zea: clean TWO PLAYER COMBAT path stage logger.
; Based on c86zdz. Diagnostic only: no gameplay/state fix.
; g2combat_stage_log is for DOS-permitted sections.
; g2combat_stage_log_protected temporarily permits DOS, writes the last stage,
; then forbids again so after-forbid stages can still be narrowed down.
g2combat_stage_log_protected
	bsr	permit
	jsr	g2combat_stage_log
	bsr	forbid
	rts
...
g2combat_stage_log
	...
	move.l	a0,d1
	move.l	#1006,d2	; MODE_NEWFILE, overwrites stale logs
	jsr	-30(a6)	; Open
	move.l	d0,d7
	beq	g2combat_stage_log_done
	move.l	d7,d1
	...
	move.l	d7,d1
	jsr	-36(a6)	; Close
g2combat_stage_log_done
	movem.l	(a7)+,d0-d7/a0-a6
	rts

g2combat_log_name	dc.b	'DH3:gloom_combat_stage.txt',0
	even
g2zea_stage_initcombat	dc.b	'C00 initnewgame combat',10
g2zea_stage_initcombat_len	equ	*-g2zea_stage_initcombat
g2zea_stage_combatfiles	dc.b	'C01 combatfiles loaded',10
g2zea_stage_combatfiles_len	equ	*-g2zea_stage_combatfiles
g2zea_stage_picktile	dc.b	'C02 pickcombat/loadtile done',10
g2zea_stage_picktile_len	equ	*-g2zea_stage_picktile
g2zea_stage_mapload	dc.b	'C03 map load returned',10
g2zea_stage_mapload_len	equ	*-g2zea_stage_mapload
g2zea_stage_initmap	dc.b	'C04 initmap done',10
g2zea_stage_initmap_len	equ	*-g2zea_stage_initmap
g2zea_stage_loadtxts	dc.b	'C05 loadtxts done',10
g2zea_stage_loadtxts_len	equ	*-g2zea_stage_loadtxts
g2zea_stage_execevent	dc.b	'C06 execevent done',10
g2zea_stage_execevent_len	equ	*-g2zea_stage_execevent
g2zea_stage_p1ok	dc.b	'C07 player1 OK',10
g2zea_stage_p1ok_len	equ	*-g2zea_stage_p1ok
g2zea_stage_p1missing	dc.b	'C07 PLAYER1 MISSING',10
g2zea_stage_p1missing_len	equ	*-g2zea_stage_p1missing
g2zea_stage_p2ok	dc.b	'C08 player2 OK',10
g2zea_stage_p2ok_len	equ	*-g2zea_stage_p2ok
g2zea_stage_p2missing	dc.b	'C08 PLAYER2 MISSING',10
g2zea_stage_p2missing_len	equ	*-g2zea_stage_p2missing
g2zea_stage_before_forbid	dc.b	'C09 before forbid',10
g2zea_stage_before_forbid_len	equ	*-g2zea_stage_before_forbid
g2zea_stage_after_forbid	dc.b	'C10 after forbid',10
g2zea_stage_after_forbid_len	equ	*-g2zea_stage_after_forbid
g2zea_stage_paldispoff	dc.b	'C11 palette/dispoff done',10
g2zea_stage_paldispoff_len	equ	*-g2zea_stage_paldispoff
g2zea_stage_p1reset	dc.b	'C12 p1 reset done',10
g2zea_stage_p1reset_len	equ	*-g2zea_stage_p1reset
g2zea_stage_p2reset	dc.b	'C13 p2 reset done',10
g2zea_stage_p2reset_len	equ	*-g2zea_stage_p2reset
g2zea_stage_positions	dc.b	'C14 positions saved',10
g2zea_stage_positions_len	equ	*-g2zea_stage_positions
g2zea_stage_before_predraw	dc.b	'C15 before predrawall',10
g2zea_stage_before_predraw_len	equ	*-g2zea_stage_before_predraw
g2zea_stage_after_predraw	dc.b	'C16 after predrawall',10
g2zea_stage_after_predraw_len	equ	*-g2zea_stage_after_predraw
g2zea_stage_after_chaton	dc.b	'C17 after dispon/chaton',10
g2zea_stage_after_chaton_len	equ	*-g2zea_stage_after_chaton
	even
