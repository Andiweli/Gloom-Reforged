...
g2v145_draw_menu_gloombrush
	tst	aga
	beq.s	.rts
	cmp	#3,g2_game_profile	; v190gv: restore v190fx Gloom3 brush placement/skip behaviour
	beq.s	.rts
	jsr	g2v142_draw_gloombrush_safe	; no brush loaded = safe no-op
.rts	rts
...
dointro	;
	...
	jsr	g2v145_show_clean_title
	bsr	dispon
	; v190gv: restore v190fx/ZM timing: Zombie g3-dc is drawn with the menu, not before it.
	cmp	#2,g2_game_profile
	beq.s	.g2v190gv_no_prebrush
	jsr	g2v145_draw_menu_gloombrush
.g2v190gv_no_prebrush
	;
	bsr	chaton
	;
...
.redrawmenu
	...
	; v190gx: all local profiles use the exact same Deluxe title menu.
	; This keeps row order, separators, default selection and item actions
	; identical for Gloom, Gloom Deluxe, Gloom3 and Zombie Massacre.
...
.notlinked
	...
	and	#$00ff,d0
	; v190gx: all local profiles use the normal Gloom Deluxe startmenu mapping.
	; The compact Gloom3/Zombie branch is deliberately not entered anymore,
	; otherwise ABOUT/EXIT and player rows drift out of sync.
	tst	d7
...
startmenu_g3zm	dc.b	12		; v190gx: legacy unused, redirected to startmenu
	dc.b	'START LEVEL '
g2v190gq_level_text	dc.b	'MAP1.1',0	;0, synced with g2v190f_level_text
	dc.b	'ONE PLAYER GAME',0	;1 default selected/blinking
...
initmenu2	;
	...
	bsr	initfontpal
	; v190gx: hard safety - there is only one local title menu path.
	; Any legacy compact/compat menu pointer is redirected to startmenu here.
	cmp.l	#startmenu_g3zm,a4
	bne.s	.g2v190gx_chk_compat_menu
	lea	startmenu,a4
	bra.s	.g2v190gu_menu_ok
.g2v190gx_chk_compat_menu
...
.titlemenu_main	move	#-1,g2v154_titlemenu_lines
	...
	bra.s	.titlemenu_y_done
.titlemenu_g3zm	move	#3,g2v154_titlemenu_lines	; v190gw: compact G3/ZM dotted lines stay on blank rows
