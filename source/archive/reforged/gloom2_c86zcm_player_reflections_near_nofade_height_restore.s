	...
	;gloom2_c86zcm: from clean c86zc7/c86zcl reflection-only path; keep TWO PLAYER player reflections, restore c86zc7 near height, prevent immediate-near fade-out by dither only.
	;
...
.g2c57_player_try_blob
	; c86zcm: in TWO PLAYER modes the other player should get the same
...
.rh_mid
	...
	bra.s	.rh_cap_apply
.rh_near
	; c86zcm: restore the confirmed c86zc7 close-height cap.
	; Only the near transparency/dither below is strengthened; size stays unchanged.
	moveq	#24,d1		; close: original c86zc7 max height
.rh_cap_apply
	cmp	d1,d0
	ble.s	.rh_max_ok
	move	d1,d0
...
.yloop
	...
	; c86zcm: do not let immediate-near enemy/player mirror reflections
...
readmenujoy	;encode to d0!
	...
	rts
.doit	lea	joyx,a0
	jsr	readjoy1	;c86zcm build-safe absolute call after added reflection code
	lea	joyx0,a0
	bsr	readkeys
	move.l	joyx0(pc),d0
	or.l	d0,joyx
