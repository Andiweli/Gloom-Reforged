...
.nofloor	;
	bsr	drawshapes
	; v17: original gloom2 had an early RTS here, making blood/pixelate unreachable.
	; Keep the renderer path alive so MEATY/MESSY can actually show splats.
	bsr	drawblood
	;
	move.l	player_(pc),a0
...
.pix	;
	...
	lea	coloffs,a2
	add.l	0(a2,d0*4),a1
	mulu	chunkymodw(pc),d1	;v19: chunkymod word is 0, chunkymodw is 320 stride
	;
...
mainloop	addq	#1,g2logframe
	move	g2logframe(pc),d0
	and	#$3f,d0
	bne.s	.g2v22_skip_looplog
	lea	g2log_msg_mainloop(pc),a0
	jsr	g2log
.g2v22_skip_looplog
	bsr	drawall
	move	g2logframe(pc),d0
	and	#$3f,d0
	bne.s	.g2v22_skip_drawok
	lea	g2log_msg_draw_ok(pc),a0
	jsr	g2log
.g2v22_skip_drawok
	move	escape(pc),d0
	beq.s	.noesc
...
g2log_drawstep	;a0 = marker, only writes on each 64th logged frame
	movem.l	d0-d7/a0-a6,-(a7)
	move	g2logframe,d0
	and	#$3f,d0
	bne.s	.g2lds_done
...
g2loghand	dc.l	0
g2logframe	dc	0
g2log_msg_open	dc.b	'G2LOG OPEN v25 DRAWSTEP DH3',0
