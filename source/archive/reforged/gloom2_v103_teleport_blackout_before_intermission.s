...
.pixnz	cmp	#12,ob_pixsize(a5)	;v102: finish earlier while visible pixel blocks remain
	...
	; v103: do not keep the final blue pixel chamber screen visible during
	; intermission loading.  Show one clean black C2P frame, then let the main
	; loop leave the level; the intermission appears only after it is ready.
