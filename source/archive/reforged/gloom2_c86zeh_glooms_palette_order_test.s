...
g2v10_map_loaded
	...
	; c86zeh: match working gloom.s order more closely: build shade palettes
	; before Forbid, while the map/event load phase is still in the DOS-safe window.
	bsr	calcpalettes
	bsr	forbid
	;
...
.g2v190cj_no_game_pal
	; c86zeh: calcpalettes already ran before Forbid, like gloom.s.
	bsr	dispoff
	;
	;
	;init player vars...
