...
g2fill_void_fog
	; v190az: keep the corridor/room openings dark like neighbouring walls,
...
.noroof	;
	...
	jsr	g2log_drawstep
.nofloor	;
	; v190ba: apply uniform sampled far-corridor fog after walls and flats.
	; Flat rendering skips non-zero pixels, so doing this earlier made whole
	; vertical columns block floor/ceiling rendering.  Doing it here only fills
	; the still-empty far corridor/portal pixels before sprites/effects draw.
	jsr	g2fill_void_fog
