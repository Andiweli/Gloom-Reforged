...
.rx_ok
	...
	divs	d2,d0
	add	midy(pc),d0
	add	#12,d0		; v184: push pickup reflections another ~5px lower on the floor
	cmp	#2,d0
...
checkany	movem.l	d0-d7/a0-a6,-(a7)
	bsr	vwait
	bsr	readmenusel
	and	#$10,d0	; set NE if fire/return activated
	qkey	$45
	beq.s	.noesc_titlewait
	or	#$10,d0	; v184: ESC also opens the title menu from the title screen wait
.noesc_titlewait
	movem.l	(a7)+,d0-d7/a0-a6
	rts
