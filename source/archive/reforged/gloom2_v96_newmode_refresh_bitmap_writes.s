...
.done	;
	bsr	disownblitter
	bsr	g2os_refresh_showbitmap	;v96: NewMode/P96 may copy custom bitmaps; push direct text writes
	rts
...
.bwait	btst	#6,$dff002
	...
	;
	bsr	disownblitter
	bra	g2os_refresh_showbitmap	;v96: push restored menu strip to NewMode/P96 screen
...
newscreen	dc	0,0	;x,y ;v95: no horizontal screen offset; fits 320x240 NewMode/P96 and recenters A1200/WinUAE
...
g2os_refresh_showbitmap	;v96: in NewMode/P96, direct writes to the custom
	; bitmap are not always reflected until ChangeVPBitMap is called again.
	tst	os
	beq.s	.rts
	movem.l	d0/a0-a2/a6,-(a7)
	move.l	viewport(pc),d0
	beq.s	.done
	...
	beq.s	.got
	lea	osbitmap2(pc),a1
.got	move.l	viewport(pc),a0
	move.l	dbufinfo(pc),a2
	move.l	grbase(pc),a6
	jsr	-$3ae(a6)	;ChangeVPBitMap
.done	movem.l	(a7)+,d0/a0-a2/a6
.rts	rts
