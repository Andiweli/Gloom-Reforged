	...
	;gloom2p96_c86zb1: grounded enemy reflections from c86y kept; flying enemy reflections off; enemy reflections blocked while enemy is still behind doors/windows/transparent strips.
	;
...
.g2v190dm_floor_fog
	...
	jsr	g2fill_disabled_flat_fog
.nofloor	;
	; c86za: disable the first wall-reflection probe again.
	; The c86x/c86y post-process wall reflection is not ready and could cause
	; black flickering vertical lines.  Keep the routine in the file, but do not call it.
