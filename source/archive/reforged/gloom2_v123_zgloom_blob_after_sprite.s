...
.ycdone2	move.l	d6,d1
	lsr.l	#1,d1
.ycdone	;
	bsr	g2_prepare_enemy_blob_from_shape	;v123 ZGloom-style sprite-box blob
	;
	;draw bit...
	;
	...
	bsr	g2_draw_pending_blob_after_sprite	;v123 draw shadow after sprite using saved box
	;
	move.l	(a7)+,a6
	bra	.drawloop
	;
...
; -----------------------------------------------------------------------------
; v123 ZGloom-style enemy blob shadow.
...
g2_prepare_enemy_blob_from_shape
	...
	tst	ob_hitpoints(a2)
	ble	.done
	; reject obvious non-monsters even if they use drawshape_8 later
	move.l	ob_logic(a2),d5
	move.l	#monsterlogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#baldylogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#terralogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#ghoullogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#phantomlogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#demonlogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#lizardlogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#deathheadlogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#dragonlogic,d6
	cmp.l	d6,d5
	beq	.enemyok
	move.l	#trolllogic,d6
	cmp.l	d6,d5
	bne	.done
.enemyok
...
.rymaxok
	move	d1,g2_blob_ry
	; map visible dark grey into current chunky palette
	move	#$555,d4
	move.l	planar_remap(pc),a0
	move.b	0(a0,d4.w),d4
	and	#$00ff,d4
...
g2_blobshadow	dc	-1	;v116c menu flag, v123 enables enemy blob rendering
