...
.vloop	move.b	(a0)+,d0
	beq.s	.skip
	move.b	d0,(a3)		;v63: gunpic was already remapped by remapanim
.skip	add.l	d5,a3
	dbf	d4,.vloop
	dbf	d2,.hloop
	;
...
g2drawgun
	...
	beq.w	.g2dg_done
	move.l	d0,a0
	move.l	12(a0),d0	;shape #0 offset
	beq.w	.g2dg_done
	cmp.l	#$20000,d0
	bcc.w	.g2dg_done
	...
	; Y is intentionally 25 pixels below the 240-line viewport, so the
	; lower part is clipped instead of corrupting the chunky buffer.
	move	#160,d1
	sub	d0,d1		;x
	move	#265,d4
	sub	d3,d4		;screen y = 240 - h + 25
	;
