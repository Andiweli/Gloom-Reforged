...
.notp	;
	...
	bra.s	.notpix
	;
.pixnz	cmp	#12,ob_pixsize(a5)	;v102: finish earlier while visible pixel blocks remain
	blt.s	.notpix
	;
	...
	move	#50,g2teleport_black_hold	;v105: keep black for about 1 second at PAL 50Hz
...
.noesc	lea	g2log_msg_finish_check,a0
	jsr	g2log
	; v105: after the visible exit teleport pixel frame, hold a real black
	; screen for about one second before allowing the intermission screen.
