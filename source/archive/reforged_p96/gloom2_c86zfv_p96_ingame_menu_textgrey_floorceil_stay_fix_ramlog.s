...
.fskip	move	floorflag,floorflag2	;c86p: keep 2P swapped floor flag in sync for cfg/gameplay
	...
	jsr	opton		;c86zfv: redraw only this row; keep P96 menu bridge visible
	jsr	g2v17_wait_menu_release	;c86zfv: stay in menu after toggle
	bra	.loop
.notfloor
	cmp	#5,d0
	bne.s	.notroof
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: ingame menu textgrey floorceil OK',10
...
g2p96_menu_pixel_rgb565
	...
	cmp	#2,d1
	beq.s	.grey2
	move	#$bdf7,d2	; light grey
	bra.s	.done
.grey2	move	#$8c71,d2	; mid grey
	bra.s	.done
.grey1	move	#$5aeb,d2	; dark grey
	bra.s	.done
.normal	add	d1,d1
	move	0(a5,d1.w),d2
