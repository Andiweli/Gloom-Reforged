...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 320x192 framebuffer 63-pen luma active',10
...
.c22paladdr
	...
	;gloom2p96_c36: keep the safe no-palette-init path, but spread
	;the sampled brightness over existing Workbench/P96 pens 1..63.
	;This is still NOT true RGB output.  It checks whether the current
	;screen has an even wider useful existing pen range, without touching
	;Palette/SetRGB again.
