...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 320x192 framebuffer 31-pen luma active',10
...
.c22paladdr
	...
	;gloom2p96_c35: keep the safe no-palette-init path, but spread
	;the sampled brightness over existing Workbench/P96 pens 1..31.
	;This is still NOT true RGB output.  It is a controlled stress/quality
	;test to see whether the current screen has more usable existing pens
	;without touching Palette/SetRGB again.
	move	d1,d0		;brightness 0..45
	add	d0,d0		;*2
	add	d1,d0		;*3
	lsr	#2,d0		;approx 0..33
	cmp	#30,d0
	ble.s	.c35rangeok
	moveq	#30,d0
.c35rangeok
	addq	#1,d0		;existing pen 1..31
.c22fallback
	and	#15,d0
	bne	.c22mapped
	moveq	#1,d0
