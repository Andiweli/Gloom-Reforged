...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 320x192 framebuffer true 127-pen luma active',10
...
.c22paladdr
	...
	;gloom2p96_c38: keep the safe no-palette-init path and stretch
	;the sampled brightness over existing Workbench/P96 pens 1..127.
	;No SetRGB/pen allocation is used here; this is only a broader
	;existing-pen luma probe based on the stable c37 path.
	move	d1,d0		;brightness 0..45
	add	d1,d0		;*2
	add	d1,d0		;*3 -> approx 0..135
	cmp	#126,d0
	ble.s	.c38rangeok
	moveq	#126,d0
.c38rangeok
	addq	#1,d0		;existing pen 1..127
	bra	.c22mapped
.c22fallback
