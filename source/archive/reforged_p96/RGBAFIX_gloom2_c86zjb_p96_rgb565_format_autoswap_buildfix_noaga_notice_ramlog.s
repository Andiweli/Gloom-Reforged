...
;gloom2_c86zdi: stronger near vertical oval, whole projectile/upgrade reflection Bayer-dithered, weapon-upgrade floor-touch pulse.
	...
	;c86zjb: query the selected P96 ModeID RGBFormat and byte-swap RGB565 only
	;for RGBFB_R5G6B5PC ($04); native RGBFB_R5G6B5 ($0A) stays unswapped.
...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zjb 11.07.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
p96modeid_rgbformat	dc.l	RGBFB_R5G6B5PC	;c86zjb: safe fallback keeps old byte-swap
...
g2p96_modeid_probe	push
	...
	clr	p96modeid_depth
	clr	p96modeid_state
	move.l	#RGBFB_R5G6B5PC,p96modeid_rgbformat	;c86zjb fallback
	move	g2display_mode(pc),d0
	cmp	#1,d0
	bne.s	.have_nonaga
...
g2p96_gameplay_rgb12_to_rgb565_c86zds
	...
	or	d3,d2		;B 0..31
	or	d2,d1		;RGB565
	cmp.l	#RGBFB_R5G6B5,p96modeid_rgbformat	;c86zjb native 68k word order?
	beq.s	.noswap
