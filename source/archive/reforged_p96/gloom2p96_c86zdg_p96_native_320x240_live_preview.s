	...
	;gloom2p96_c86zdg: rollback from 640x384 shell scaling; test native 320x240 P96 preview by sampling 160x120 and doubling only to 320x240.
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86zdg native 320x240 live preview active',10
...
.c26copyrow2
	...
	dbf	d3,.c26copyrow2
.c26noframemirror
	;c86zdg: draw the main preview from the mirrored 320x240
	;framebuffer when available.  If allocation ever failed, safely fall
	;back to the proven c25 expanded linebuffer for this row.
	;c86zdg: draw the complete 120-row sampled preview into the full 320x240 target.
	;Destination is 320x240 at y=0..239; no letterbox/upscale shell.
	move.l	p96preview_frameptr(pc),d0
