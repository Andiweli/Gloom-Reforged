...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 (v1.6 c86zjg 12.07.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
g2p96_menu_native_nav_present
	...
	jsr	g2p96_title_menu_native_restore_current_row
	jsr	g2p96_menu_native_draw_current_row_no_restore
	bra.s	.done
.not_title
	cmp	#P96DSP_MENU_BRIDGE,p96display_state
	bne.s	.done
	...
	add	d1,d0
	move	d0,p96menu_bridge_y_end
	jsr	g2p96_menu_native_restore_current_row
	jsr	g2p96_menu_native_draw_current_row_bigfont_delta_no_restore
.done
	movem.l	(a7)+,d0-d1
	rts
...
.not_title
	...
	add	d1,d0
	move	d0,p96menu_bridge_y_end
	jsr	g2p96_menu_recompose_current_row_planar	;c86zgl: real bigfont row in menubmap
	jsr	g2p96_menu_native_restore_current_row
	jsr	g2p96_menu_native_draw_current_row_bigfont_delta_no_restore
.done
	movem.l	(a7)+,d0-d1
