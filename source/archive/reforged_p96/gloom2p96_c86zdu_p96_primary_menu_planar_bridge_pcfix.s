...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86zds P96 primary no AGA present active',10
...
g2p96_planar_get_pixel_index
	...
	move	d2,d1
	lsr	#3,d1
	add	d1,d0		; byte offset in one plane
	moveq	#7,d1
	and	d2,d1
	moveq	#7,d2
	sub	d1,d2		; bit number within byte
	moveq	#1,d1
	lsl	d2,d1		; bit mask
	moveq	#0,d3
	move.l	a6,a0
