...
.bwait	btst	#6,$dff002
	...
	;
	bsr	disownblitter
	jsr	g2p96_menu_bridge_present	;c86zfr: update P96 copy after restoring menu strip
	rts
...
.loop	addq	#1,d0
	...
	;
	move	#13,flashdelay
	jsr	g2p96_menu_bridge_present	;c86zfr: update P96 copy after selected-row redraw
	;
	rts
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: ingame menu grey/live floorceil OK',10
