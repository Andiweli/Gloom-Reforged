...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zez 30.06.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
p96modeid_msg_notfound	dc.b	'P96 modeid: not found 320x240',10
...
p96screen_depth_tag	dc.l	SA_Depth,16
	...
	cnop	0,4
p96modeid_tags
	dc.l	P96BIDTAG_NominalWidth,320
	dc.l	P96BIDTAG_NominalHeight,240
p96modeid_depth_tag
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: primary sharpness probe OK',10
...
; c86zfe: a0 = Window.  Overlay a small true 1:1 black/white pixel
...
; a0 = Window.  c86zfb full-source P96-primary present.
; Writes the full 320x240 chunky source through the c86zds source-byte ->
; RGB565 LUT directly into the open P96 bitmap.  The caller skips the old
...
g2p96_gameplay_draw_mini_frame_160x96
	...
	move	0(a2),d4	; BitMap.BytesPerRow
	and.l	#$0000ffff,d4
	cmp	#640,d4		; this probe is the confirmed 16-bit RGB565 target only
	blo.w	.done
	move	#-1,p96gameplay_direct_state
	bsr	g2p96_gameplay_build_rgb565_source_lut

	; Include Window offsets for completeness, although the probe window is 0,0.
	moveq	#0,d0
...
.pixloop
	...
	add	d1,d1
	move	0(a5,d1.w),d2	; RGB565 from c86zds LUT
	move	d2,(a1)+
	addq	#1,d7
	bra.s	.pixloop
.nextrow
