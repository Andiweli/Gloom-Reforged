...
; -----------------------------------------------------------------------------
; c86zem: bounded 160x96 gameplay mini-frame burst after c86zel proved visible
...
; -----------------------------------------------------------------------------
p96gameplay_state		dc	0	;0=fail, 1=160x96 burst OK, 2=skip AGA, 3=no P96 lib, 4=no ModeID, 5=no intuition, 6=screen fail, 7=window fail, 8=no graphics
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: 160x96 burst OK',10
...
.have_p96
	...
	bra	.log
.try_marker
	jsr	g2p96_gameplay_160x96_burst_probe
.log
...
g2p96_gameplay_160x96_burst_probe
	push
	move.l	p96modeid,d0
	beq	.nomode
	move.l	d0,p96winprobe_displayid_tag+4
	...
	moveq	#2,d7	;3 bounded mini-frame updates, then return to AGA
.burst_loop
...
.colloop
	...
	eor	d6,d3
	eor	d7,d3
	move	p96gameplay_burst_phase,d0	;small visible phase change per mini-frame
	eor	d0,d3
	and	#1,d3
	move.l	50(a5),a1
	move.l	p96gameplay_grbase,a6
