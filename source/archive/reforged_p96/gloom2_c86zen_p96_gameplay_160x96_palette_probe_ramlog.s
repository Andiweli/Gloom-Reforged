...
p96gameplay_msg_ok	dc.b	'P96 gameplay: 160x96 palette OK',10
...
g2p96_gameplay_160x96_palette_probe
	...
	moveq	#2,d7	;3 bounded colour mini-frame updates, then return to AGA
.burst_loop
...
g2p96_gameplay_tiny_wait
	push
	moveq	#1,d7	;tiny wait between bounded mini-frame burst updates
.wait
	move.l	p96gameplay_grbase,d0
	beq	.done
	move.l	d0,a6
