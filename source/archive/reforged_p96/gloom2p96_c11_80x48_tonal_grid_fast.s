...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 80x48 tonal grid fast active',10
...
g2p96_preview_frame	push
	...
	and	#7,d0		;gloom2p96_c11: update every 8th frame
	bne.w	.done
...
.nolog	movem.l	d0-d7/a0-a6,-(a7)
	...
	; block grid, every 8th frame.  c3 proved that full-window sampling was
	...
	; raises update cadence; the real-hardware probe still conservative this stage updates every
	; 8th frame and still uses safe RectFill pens.  AGA output remains
