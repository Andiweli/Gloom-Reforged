...
;gloom2_c86zdi: stronger near vertical oval, whole projectile/upgrade reflection Bayer-dithered, weapon-upgrade floor-touch pulse.
	...
	;c86zho: ignore disabled icon ToolTypes in parentheses, e.g. (DISPLAY=P96).
...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zho 09.07.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
.loop	move.l	(a2)+,d0
	beq	.free
	move.l	d0,a0
	bsr	g2tooltype_disabled	;c86zho: ignore icon ToolTypes disabled as (DISPLAY=...)
	tst	d0
	bne	.loop
...
; c86zho: Workbench icon ToolTypes wrapped in parentheses are disabled by
