...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zgw 09.07.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
.done	; v190hy cleanup: log marker removed
	jsr	printmess2
	jsr	g2p96_static_present_showbitmap_font_if_bridge	;c86zgv: present completed intermission text to P96
	;
	tst	pdelay
	bmi	execscript
	clr	pdelay
...
.g2v158_no_title_credit
	bsr	swapshow
	bsr	db
	jsr	g2p96_static_present_showbitmap_font_if_bridge	;c86zgv: title menu text uses font-aware LUT
	bra	vwait
