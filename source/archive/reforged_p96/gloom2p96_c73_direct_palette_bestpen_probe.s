...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c73 direct palette bestpen probe active',10
...
.c50penok
	tst	p96bestpen_state	;c71: translate bottom-probe RGB332 candidate through same BestPen map
	beq.s	.c71c50nomap
	and	#$00ff,d0
	lea	p96bestpen_map,a6
	move.b	0(a6,d0.w),d0
.c71c50nomap
	move.l	50(a5),a1
	move.l	grbase(pc),a6
	jsr	-342(a6)	;SetAPen(BestPen-mapped RGB332 Pen candidate)
	move	d5,d0
	move	d6,d1
