...
;gloom2_c86zdi: stronger near vertical oval, whole projectile/upgrade reflection Bayer-dithered, weapon-upgrade floor-touch pulse.
	...
	;gloom2_c86zee: first visible gameplay P96 frame-marker probe; one-shot, no AGA-present skip.
	;
...
.waitskip2	; c86m: normal C2P/show path restored after c86l label regression
	jsr	doc2p
	jsr	db
	jsr	g2p96_gameplay_present_probe	;c86zee: one-shot visible gameplay P96 frame-marker probe
	ifne	g2p96_overlay_enabled
...
; -----------------------------------------------------------------------------
; c86zee: first visible gameplay P96 frame-marker probe.  This is still not the
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: frame-marker OK',10
