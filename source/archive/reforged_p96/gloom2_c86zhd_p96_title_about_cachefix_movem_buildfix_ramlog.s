...
;gloom2_c86zdi: stronger near vertical oval, whole projectile/upgrade reflection Bayer-dithered, weapon-upgrade floor-touch pulse.
	...
	;c86zhd: keep c86zhb safe qmenu restore; avoid redundant P96 title/about reloads and fix disabled in-game rows.
...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zhd 09.07.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
.noch	bsr	g2v147_finitmenu_soft
	...
	jsr	g2p96_title_about_return_fast_if_bridge	;c86zhd: ABOUT exit under P96 restores cached title instead of reloading IFF
	tst	d0
	bne.s	.g2c86zhd_about_return_fast
	jsr	g2v145_show_clean_title
	bsr	dispon
.g2c86zhd_about_return_fast
	bra	.redrawmenu
...
g2v147_pmenu_soft	;a0=iff, a1=palette, a2=menu
	move.l	a2,-(a7)
	jsr	g2p96_title_about_fast_background_if_bridge	;c86zhd: ABOUT can reuse staged title background under P96
	tst	d0
	bne.s	.g2c86zhd_fast_about_bg
	bsr	showpic_noclear
.g2c86zhd_fast_about_bg
	move.l	(a7)+,a4
	bsr	initmenu
	bra	dispon
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: title/about cachefix movem buildfix OK',10
