...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 320x192 framebuffer true 63-pen luma active',10
...
.c22paladdr
	...
	;gloom2p96_c37: keep the safe no-palette-init path, but really spread
	;the sampled brightness over existing Workbench/P96 pens 1..63.
	;Earlier c36 still fell through the old fallback mask after mapping;
	;this version branches around that fallback for the normal palette path.
	move	d1,d0		;brightness 0..45
	add	d1,d0		;*2
	add	d1,d0		;*3
	lsr	#1,d0		;approx 0..67
	cmp	#62,d0
	ble.s	.c37rangeok
	moveq	#62,d0
.c37rangeok
	addq	#1,d0		;existing pen 1..63
	bra	.c22mapped
.c22fallback
