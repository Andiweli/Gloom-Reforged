	...
	;gloom2p96_c52: replace the bottom probe Pen path with P96 ARGB RectFill.
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: RGB24 ARGB rectfill bottom probe active',10
...
p96preview_rgb24bottomptr	dc.l	0	;gloom2p96_c52: intentionally unused; no c48-style bottom buffer
...
.c50xloop
	...
	;gloom2p96_c52: first real RGB-colour output attempt.  Do not map
	;the RGB24 linebuffer through Workbench Pens anymore.  Instead call
	;Picasso96API.library/p96RectFill with a real ARGB colour for each
	;2x1 bottom probe block.  This is still deliberately tiny and isolated:
	;no WriteTrueColorData full-frame path, no extra RGB24 bottom buffer,
	;and no palette/SetRGB changes.
	moveq	#0,d7
	move.b	d4,d7		;R
	lsl.l	#8,d7
	move.b	d1,d7		;G
	lsl.l	#8,d7
	move.b	d2,d7		;B
	or.l	#$ff000000,d7	;ARGB alpha/opaque marker for P96
	move.l	50(a5),a0	;Window.RPort for p96RectFill
	...
	addq	#1,d2
	move	d1,d3
	move.l	d7,d4		;true ARGB colour from RGB24 linebuffer
	jsr	-126(a6)	;p96RectFill(rp,x,y,x+1,y,ARGB)
	addq	#2,d5
	bra	.c50xloop
.c50skipdirectrgb24
