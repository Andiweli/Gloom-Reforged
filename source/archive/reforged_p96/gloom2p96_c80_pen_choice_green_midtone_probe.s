...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c80 pen-choice green midtone probe active',10
...
g2p96_c73_palready
	...
	; gloom2p96_c80: keep c75 as the visual anchor and do not recolour
	; texture pixels directly.  Instead, slightly bias only the pen choice
	; for midtone colours that are already green-dominant.  This should
	; help the Workbench/P96 ColorMap pick a greener near-match without
	; sending unrelated texture areas into Shrek mode.
	move	d6,d4
	and	#$0f00,d4
	lsr	#8,d4		;R nibble
	move	d6,d5
	...
	cmp	#3,d1
	bhi	.c80nopenbias
	add.l	#$08080808,d2	;small green nudge for ObtainBestPenA only
.c80nopenbias
