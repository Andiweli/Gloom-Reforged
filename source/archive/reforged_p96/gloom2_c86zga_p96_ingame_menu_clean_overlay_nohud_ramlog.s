...
.menu_backdrop_done
	...
	lea	gamemenu,a4
	jsr	initmenu
	jsr	g2p96_menu_prepare_backdrop_nohud	;c86zga: copy paused gameplay without HUD to P96
	jsr	g2p96_menu_bridge_all_rows_present	;c86zga: overlay only menu glyph pixels
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: ingame menu clean overlay nohud OK',10
...
g2p96_ingame_menu_floorceil_live_refresh
	...
	jsr	g2p96_menu_prepare_backdrop_nohud	;c86zga: refresh paused game backdrop without HUD
	jsr	g2p96_menu_bridge_all_rows_present	;c86zga: overlay menu text only, no grey panel
	bra.s	.refresh_done
.aga_refresh
	jsr	g2v190aj_grey_menu_backdrop
.refresh_done
