...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c84 raw palette pen diagnostic active',10
...
g2p96_c73_palready
	...
	; gloom2p96_c84: diagnostic raw-pen output.  Do NOT ask the
	; Workbench/P96 ColorMap for a nearest Pen.  Instead pass the active
	; Gloom palette index straight through to SetAPen/RectFill.  If this
	; looks closer to AGA, public screen pens are usable directly; if it
	; looks wrong/false-coloured, the next step must be an own P96 screen
	; or true RGB pixel path instead of public Workbench pens.
	move	d7,d0
	and	#$00ff,d0
	move.b	d0,0(a2,d7.w)
	bra	g2p96_c73_next
