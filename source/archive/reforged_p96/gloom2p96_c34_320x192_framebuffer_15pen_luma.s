...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 320x192 framebuffer 15-pen luma active',10
...
.c22paladdr
	...
	;gloom2p96_c34: keep the safe no-palette-init path, but spread
	;the sampled brightness over the existing Workbench/P96 pens 1..15
	;instead of only 1..8.  This still is NOT true RGB output, but it
	;checks whether the current screen has enough useful existing pens
	;before risking another palette/API change.
	cmp	#3,d1
	blt	.c22pen1
	cmp	#6,d1
	blt	.c22pen2
...
.c22pen9	moveq	#9,d0
	bra	.c22mapped
.c22pen10	moveq	#10,d0
	bra	.c22mapped
.c22pen11	moveq	#11,d0
	bra	.c22mapped
.c22pen12	moveq	#12,d0
	bra	.c22mapped
.c22pen13	moveq	#13,d0
	bra	.c22mapped
.c22pen14	moveq	#14,d0
	bra	.c22mapped
.c22fallback
	and	#15,d0
	bne	.c22mapped
