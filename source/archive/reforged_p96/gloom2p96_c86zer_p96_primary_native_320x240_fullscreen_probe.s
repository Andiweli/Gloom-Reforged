...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86zer native 320x240 fullscreen probe active',10
...
p96test_window	dc	0,0	;x,y on P96 public screen ;c86zer native 320x240 fullscreen probe
	dc	320,240	;w,h ;c86zer no scaling, native 320x240 only
	dc.b	0,1	;pens
	dc.l	0	;no IDCMP needed for this short self-closing probe
	dc.l	$1940	;ACTIVATE|BORDERLESS|BACKDROP|SIMPLE_REFRESH, no gadgets
	dc.l	0	;gadgets
	dc.l	0	;checkmark
	dc.l	p96test_title
