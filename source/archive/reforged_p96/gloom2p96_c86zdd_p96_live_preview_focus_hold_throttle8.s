...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86zd8 Gloom palette BestPen grid active',10
...
.nolog	movem.l	d0-d7/a0-a6,-(a7)
	...
	; clean 320x192 image centered inside the 320x240 P96 overlay, with black
	; letterbox rows above and below.  This removes the old grey/unused band.
	move.l	50(a5),a1
	move.l	grbase(pc),a6
	moveq	#0,d0
	...
	move	#319,d2
	move	#23,d3
	jsr	-306(a6)	;RectFill top letterbox
	move.l	50(a5),a1
	move.l	grbase(pc),a6
	moveq	#0,d0
	jsr	-342(a6)	;SetAPen black
	...
	move	#319,d2
	move	#239,d3
	jsr	-306(a6)	;RectFill bottom letterbox
...
.c26noframemirror
	...
	;Destination is 320x192 at y=24..215; top/bottom letterbox is black.
	move.l	p96preview_frameptr(pc),d0
