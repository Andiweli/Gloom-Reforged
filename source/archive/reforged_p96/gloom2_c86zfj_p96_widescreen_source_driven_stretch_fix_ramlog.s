...
; c86zfj: read HIRES=YES/NO and STRETCH=YES/NO from ToolTypes or CLI.
...
.have_p96
	...
	bne	.stretch_hires
	; STRETCH=YES + HIRES=NO/default: prefer aligned 240-line widescreen modes
	; first.  400/424 are safer on RTG/monitors than odd 426, but 426 is
	; still tried as a final lowres 16:9-ish option.
	move	#400,d0
	move	#240,d1
	move	#3,d2
...
; -----------------------------------------------------------------------------
; c86zfj: output mode ToolTypes for the now-confirmed P96 gameplay-primary path.
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: widescreen source-driven stretch OK',10
