...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 (v1.6 c86zjp 12.07.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
wb	;
	...
	jsr	-126(a6)
.nocd	;
	jsr	g2early_aga_guard	;c86zhz: reject OCS/ECS before any display/P96 initialisation
	tst	d0
	bne	nomem
	jsr	g2displaymode_probe	;c86zdv: ToolType/CLI display-mode selection, log only
...
.agaa	bsr	loadfiles
	...
	beq.s	.g2c86zhg_blackmagic_oldpath
...
g2display_mode	dc	1	;0=AUTO, 1=AGA, 2=P96; c86zhl default/no DISPLAY = AGA
g2display_source	dc	0	;0=default, 1=ToolType, 2=CLI
g2p96_hires_mode	dc	0	;0/NO=320x240, -1/YES=640x480
g2p96_stretch_mode	dc	0	;0/NO=normal, -1/YES=widescreen stretch
...
g2displaymode_probe
	push
	move	#1,g2display_mode	;c86zhl: no DISPLAY given -> AGA, explicit AUTO still sets 0
	...
	move.l	g2display_cli_ptr(pc),d0
	beq	.log
	move.l	d0,a0
	moveq	#2,d1	;CLI source overrides ToolType if present
	bsr	g2displaymode_scan_line
	move.l	g2display_cli_ptr(pc),a0
	moveq	#2,d1
	bsr	g2p96_options_scan_line
.log
	pull
	rts
...
; a2 points just after the option name.  Returns d0=0 no value, 1 NO, 2 YES.
g2p96_options_read_yesno
	moveq	#0,d0
.eqskip	move.b	(a2)+,d1
	cmp.b	#' ',d1
	beq	.eqskip
