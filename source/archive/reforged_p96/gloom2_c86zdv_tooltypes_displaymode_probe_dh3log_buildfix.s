...
;gloom2_c86zdi: stronger near vertical oval, whole projectile/upgrade reflection Bayer-dithered, weapon-upgrade floor-touch pulse.
	...
	;gloom2_c86zdv: P96 path unlocked safely: DISPLAY ToolType/CLI probe only, log selected AGA/P96/AUTO mode; no P96 screen/output yet.
	;
...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zdv 29.06.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
dointro	;
	...
	jsr	g2v145_show_clean_title
	; c86zdu/c86zdv: keep the c86zdf prefade overlay only for Zombie
	; Massacre.  Classic Gloom/Gloom Deluxe/Gloom3 keep the older c86zc7
	; title timing, avoiding the known false-colour/crash regression.
	cmp	#2,g2_game_profile	;2 = Zombie Massacre
	bne.s	.g2c86zdu_no_prefade_brush
