	...
	;gloom2p96_c70: lite P96 preview; throttle live updates and skip expensive false-colour RGB24 bottom probe.
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c70 lite throttled P96 preview active',10
...
g2p96_preview_frame	push
	...
	and	#15,d0		;gloom2p96_c70: update only every 16th preview call
	bne.w	.done
...
.c43norgb24line
	...
	bra	.c50skipdirectrgb24	;gloom2p96_c70: skip expensive false-colour RGB24 bottom probe
	move.l	p96preview_rgb24lineptr(pc),d0
...
.c33drawfromready
	cmp	#96,d6		;gloom2p96_c70: no bottom probe; draw all main preview rows
	bge	.c22nextrow
