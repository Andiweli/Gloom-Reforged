...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 320x192 RGB24 linebuffer prep active',10
...
p96preview_rgb24lineptr	dc.l	0	;gloom2p96_c43: 320-pixel RGB24 linebuffer, 960 bytes
...
.c22nextrow
	...
	bra	.c22rowloop
.c22done
	;gloom2p96_c34: bottom framebuffer probe remains disabled.  The main
	;preview now reads from the 320x192 framebuffer mirror, so the lower
	;probe is no longer needed and would only add extra RectFill load.
	bra	.restore
