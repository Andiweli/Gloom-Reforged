...
.done	; v190hy cleanup: log marker removed
	jsr	printmess2
	jsr	g2p96_static_present_intermission_text_skip_if_bridge	;c86zgx: no pink/slow fullscreen text bridge yet
	;
	tst	pdelay
	bmi	execscript
	clr	pdelay
...
g2p96_static_build_rgb_buffer
	...
	jsr	g2p96_static_fast_log_once	;c86zjg: prove row-wise static decoder is active
	moveq	#0,d6		; source y 0..239
.rowloop
	cmp	#240,d6
	bge	.done
...
.dispatch
	jsr	g2p96_static_decode_index_row_fast	;c86zjg: a6 -> 320 linear palette indices
	move	p96target_mode,d0
	beq	.copy_1x
	cmp	#1,d0
	beq	.copy_2x
