	...
	;gloom2p96_c60: one-shot static P96 ARGB probe after testpattern, never from live hook.
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c60 static ARGB startup probe active',10
...
g2p96_test_window	push
	...
	move.l	d7,a0
	bsr	g2p96_static_argb_probe	;gloom2p96_c60: one-shot only, not live/vwait
	bra.s	.logonly
...
; gloom2p96_c60: one-shot true-colour API probe outside gameplay/vwait.
