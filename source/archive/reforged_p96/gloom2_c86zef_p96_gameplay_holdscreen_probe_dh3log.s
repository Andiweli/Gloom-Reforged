...
;gloom2_c86zdi: stronger near vertical oval, whole projectile/upgrade reflection Bayer-dithered, weapon-upgrade floor-touch pulse.
	...
	;gloom2_c86zef: gameplay P96 holdscreen probe; longer visible marker, no AGA-present skip.
	;
...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zee 29.06.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
.waitskip2	; c86m: normal C2P/show path restored after c86l label regression
	jsr	doc2p
	jsr	db
	jsr	g2p96_gameplay_present_probe	;c86zef: one-shot gameplay P96 holdscreen probe
	ifne	g2p96_overlay_enabled
...
; -----------------------------------------------------------------------------
; c86zef: gameplay P96 holdscreen probe.  This is still not the renderer and it
; still does not skip the normal AGA doc2p/db present path.  It is called once
; from the one-player show path after doc2p/db, opens the proven 320x240 P96
; screen/window, holds it visibly for a longer diagnostic interval, updates only
; a primitive marker, closes everything, and logs the result to DH3.
; -----------------------------------------------------------------------------
p96gameplay_state		dc	0	;0=fail, 1=holdscreen OK, 2=skip AGA, 3=no P96 lib, 4=no ModeID, 5=no intuition, 6=screen fail, 7=window fail, 8=no graphics
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: holdscreen OK',10
...
.have_p96
	...
	bra	.log
.try_marker
	jsr	g2p96_gameplay_holdscreen_probe
.log
...
g2p96_gameplay_holdscreen_probe
	push
	move.l	p96modeid,d0
	beq	.nomode
	move.l	d0,p96winprobe_displayid_tag+4
	...
	move.l	d4,a0
	bsr	g2p96_gameplay_draw_frame_marker
	bsr	g2p96_gameplay_holdscreen_wait
	bra	.close_window
.nogfx
...
; gameplay-time screen/window path without depending on palette conversion.
g2p96_gameplay_draw_frame_marker
	push
	move.l	a0,a5
	move.l	50(a5),a1	;Window.RPort
	move.l	a1,d0
	...
	move	#319,d2
	move	#239,d3
	jsr	-306(a6)	;bottom frame marker
	move.l	50(a5),a1
	move.l	p96gameplay_grbase,a6
	move	#144,d0
	move	#96,d1
	move	#175,d2
	move	#143,d3
	jsr	-306(a6)	;central vertical marker block
	move.l	50(a5),a1
	move.l	p96gameplay_grbase,a6
	move	#104,d0
	move	#112,d1
	move	#215,d2
	move	#127,d3
	jsr	-306(a6)	;central horizontal marker block
.done
	pull
	rts

g2p96_gameplay_holdscreen_wait
	push
	move.l	a0,a5	;Window pointer from caller
	moveq	#119,d7	;about two seconds at PAL, long enough to test hold stability
	moveq	#0,d6
.wait
	move.l	p96gameplay_grbase,d0
	beq	.done
	...
	move.l	d0,a6
	moveq	#0,d0
	jsr	-342(a6)	;SetAPen background for moving marker area
	move.l	50(a5),a1
	move.l	p96gameplay_grbase,a6
	move	#24,d0
	move	#52,d1
	move	#295,d2
	move	#75,d3
	jsr	-306(a6)	;clear moving marker band
	move.l	50(a5),a1
	move.l	p96gameplay_grbase,a6
	moveq	#1,d0
	jsr	-342(a6)	;SetAPen marker
	...
	move	#56,d1
	move	#71,d3
	jsr	-306(a6)	;moving holdscreen marker block
	addq	#1,d6
	dbf	d7,.wait
.done
	pull
