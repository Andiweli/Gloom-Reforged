...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 320x192 RGB332 penindex buildfix active',10
...
.c22paladdr
	...
	move	d2,(a5)+
.c40skiprgbstore
	;gloom2p96_c41: first visible RGB12-derived colour test.  Instead
	;of collapsing the true Gloom palette sample to luma, quantize it to
	;an RGB332-style 8-bit Pen index.  This still uses the existing
	;Workbench/P96 Pens and does NOT call SetRGB or alter any palette, so
	;it should be as safe as c39/c40 while proving that the hidden RGB12
	;buffer can drive visible colour decisions.
	move	d2,d0
	and	#$0f00,d0
	lsr	#8,d0		;R 0..15, GenAm/68000 immediate shift max is 8
	lsr	#1,d0		;R 0..7
	lsl	#5,d0		;R bits -> 7..5
	move	d2,d1
	and	#$00f0,d1
	...
	or	d1,d0		;RGB332 Pen candidate 0..255
	bne.s	.c41penok
