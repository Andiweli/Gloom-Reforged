...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 160x96 contrast tonal pens active',10
...
.c15paladdr
	...
	; gloom2p96_c21: c19/c20 proved that safe mono/dither pens are
	; stable but unreadable.  Return to the proven Workbench/P96 pens,
	; but spread the full 0..45 palette luma range over pens 1..8 instead
	; of crushing most bright pixels into the top bucket.  No pen or
	; palette setup is performed, so this keeps the c18a safety profile.
	cmp	#6,d1
	blt	.c21pen1
	cmp	#12,d1
	blt	.c21pen2
...
.c15fallback
	and	#7,d0
	addq	#1,d0		;fallback: old c5 low-bit map
.c15mapped
