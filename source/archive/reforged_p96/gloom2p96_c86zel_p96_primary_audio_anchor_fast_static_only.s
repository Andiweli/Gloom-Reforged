...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86zel audio-anchor fast-static only',10
...
.row
	...
	bge.w	.rts
	; c86zel: fast static planar bridge only.  Keep the c86zek audio/start
	; cadence untouched, but avoid calling the per-pixel helper 76,800 times
	; for every title/menu/intermission full-screen blit.
	move	d6,d0
	mulu	linemodw,d0
	move.l	a6,a0
