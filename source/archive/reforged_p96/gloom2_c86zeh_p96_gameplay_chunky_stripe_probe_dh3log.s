...
;gloom2_c86zdi: stronger near vertical oval, whole projectile/upgrade reflection Bayer-dithered, weapon-upgrade floor-touch pulse.
	...
	;gloom2_c86zeh: one-shot gameplay chunky-stripe P96 probe after safe rollback.
	;
...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zeh 29.06.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
.waitskip2	; c86m: normal C2P/show path restored after c86l label regression
	jsr	doc2p
	jsr	db
	jsr	g2p96_gameplay_present_probe	;c86zeh: one-shot visible gameplay chunky-stripe P96 probe
	ifne	g2p96_overlay_enabled
...
; -----------------------------------------------------------------------------
; c86zeh: first visible gameplay data probe after safe rollback.  This still
...
; gameplay buffer, waits only a few video frames, closes everything, and logs
; the result to DH3.
; -----------------------------------------------------------------------------
p96gameplay_state		dc	0	;0=fail, 1=chunky stripe OK, 2=skip AGA, 3=no P96 lib, 4=no ModeID, 5=no intuition, 6=screen fail, 7=window fail, 8=no graphics
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: chunky-stripe OK',10
