...
; -----------------------------------------------------------------------------
; c86zfd: P96 gameplay-primary direct RGB565 real-hardware smoke-test anchor.
; Based on the confirmed c86zfc anchor: P96-primary gameplay with delayed timing,
; full 320x240 source, old c86zds source-byte -> RGB565 LUT path, AGA high+low
; palette precision, lifecycle/menu/intermission force-close, and AGA fallback.
; This c86zfd step intentionally adds no new visual feature: it is a labelled
; real-hardware smoke-test anchor for emulator-vs-real-Amiga validation.
; -----------------------------------------------------------------------------
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: primary realhw smoke OK',10
