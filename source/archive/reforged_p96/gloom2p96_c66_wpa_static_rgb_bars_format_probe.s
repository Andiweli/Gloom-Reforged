	...
	;gloom2p96_c66: static RGB bars via p96WritePixelArray format probe.
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c66 WPA static RGB bars format probe active',10
...
p96wpalog_name	dc.b	'RAM:gloom_p96_wpa.txt',0
	even
p96wpalog_ok	dc.b	'P96 WPA: static RGB bars p96WritePixelArray returned',10
...
; gloom2p96_c66: static RGB-format probe via p96WritePixelArray.
...
p96c66_white_loop
	...
	clr	6(a0)		;pad
	move.l	#2,8(a0)	;RGBFB_R8G8B8 source data
	moveq	#0,d0		;SrcX
	moveq	#0,d1		;SrcY
	moveq	#0,d2		;DestX
...
p96wpa_ri	dc.l	0
	dc	0
	dc	0
	dc.l	2	;RGBFB_R8G8B8 for c64 live game-band probe
	even
