...
; -----------------------------------------------------------------------------
; c86zfc: P96 gameplay-primary direct RGB565 lifecycle/intermission-safe probe.
; Based on the confirmed c86zey/c86zez anchor: delayed timing, full 320x240
; source, old c86zds source-byte -> RGB565 LUT path, and AGA high+low palette
; precision.  New in this step: once the P96 copy succeeds for a gameplay
; frame, the old AGA doc2p/db presentation is skipped for that frame.  If P96
; is unavailable or the direct copy fails, the normal AGA path runs unchanged.
; -----------------------------------------------------------------------------
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: primary lifecycle intermission OK',10
