...
g2p96_menu_selmenu_stable
	jsr	opton		;c86zgq: build selected row once with real Bigfont
...
.up
	...
	jsr	optoff		;c86zgs: old row becomes normal before curropt changes
.up_loop
	subq	#1,curropt
	bpl	.up_chk
	move	numopts,d0
...
.up_chk
	jsr	menuskip
	beq	.up_loop
	jsr	opton		;c86zgs: build new selected row with real Bigfont once
