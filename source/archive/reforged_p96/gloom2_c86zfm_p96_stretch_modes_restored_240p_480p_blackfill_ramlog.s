...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zfm 30.06.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
; -----------------------------------------------------------------------------
; c86zfm: restored confirmed 240p widescreen modes plus 480p blackfill fix.
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: stretch modes 240p/480p blackfill OK',10
...
g2p96_gameplay_draw_mini_frame_160x96
	...
	; c86zfm: keep the confirmed 240p stretch path, but retain the c86zfl
	; blackfill for 480-line widescreen so exposed rows stay black, not gray.
	move	p96target_mode,d0
	cmp	#2,d0
	bne	.no_c86zfm_stretch_clear
	bsr	g2p96_gameplay_clear_p96_screen
.no_c86zfm_stretch_clear
