	...
	;gloom2p96_c5: safe one-scanline Chunky preview; heartbeat path kept.
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: single scanline active',10
...
.c5xloop
	...
	and	#7,d0
	addq	#1,d0		;map to safe pens 1..8
	move.l	50(a5),a1
	move.l	grbase(pc),a6
