...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 160x96 runfill tonal grid active',10
...
g2p96_preview_frame	push
	...
	and	#3,d0		;gloom2p96_c16: update every 4th frame
	bne.w	.done
...
.nolog	movem.l	d0-d7/a0-a6,-(a7)
	...
	; block grid, every 4th frame.  c3 proved that full-window sampling was
	...
	beq.w	.restore
	lea	coloffs(pc),a3
	; gloom2p96_c16: c15 proved that the 80x48 runfill grid is stable.
	...
	; update rate is lowered to every 4th frame as a safe load test.
