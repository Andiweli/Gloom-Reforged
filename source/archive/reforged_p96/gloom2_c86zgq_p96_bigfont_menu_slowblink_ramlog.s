...
;gloom2_c86zdi: stronger near vertical oval, whole projectile/upgrade reflection Bayer-dithered, weapon-upgrade floor-touch pulse.
	...
	;c86zgq: keep c86zgp real Bigfont/P96 menu anchor, add slow P96-only
...
g2release_marker	dc.b	'Gloom Reforged AGA/P96 probe (v1.4 c86zgq 09.07.2026) Andreas ',39,'Andiweli',39,' Stuermer',0
	even
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: stable bigfont P96 menu blink OK',10
...
.up_chk
	jsr	menuskip
	beq	.up_loop
	jsr	opton		;c86zgq: highlight new row immediately
	move	#-1,p96menu_blink_visible
	move	#22,p96menu_blink_count
	bra	.wait
.down
