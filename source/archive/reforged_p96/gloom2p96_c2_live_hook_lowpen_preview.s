	...
	;gloom2p96_c2: P96 preview heartbeat + low-pen chunky sample; AGA output unchanged.
	;
...
p96livelog_name	dc.b	'RAM:gloom_p96_live.txt',0
	even
p96livelog_ok	dc.b	'P96 live: frame hook hit',10
...
; gloom2p96_c1: open a persistent Workbench/P96 preview window.
; This still does NOT replace AGA output.  The window first shows the
; old testpattern, then g2p96_preview_frame samples the Chunky buffer into
...
initdisplay	;
	...
	jsr	-408(a6)
	move.l	d0,int
	jsr	g2p96_test_window	;gloom2p96_c1: persistent coarse P96 preview window, AGA path unchanged
	;
