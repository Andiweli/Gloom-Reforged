...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 80x48 tonal grid active',10
...
g2p96_preview_frame	push
	...
	and	#31,d0		;gloom2p96_c10: update only every 32nd frame
	bne.w	.done
...
.nolog	movem.l	d0-d7/a0-a6,-(a7)
	...
	; block grid, every 32nd frame.  c3 proved that full-window sampling was
	...
	; Step up to an 80x48 tonal grid with 4x4 blocks.  To keep the
	; real-hardware probe conservative this stage updates only every
	; 32nd frame and still uses safe RectFill pens.  AGA output remains
