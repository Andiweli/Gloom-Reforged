...
.waitskip2	; c86m: normal C2P/show path restored after c86l label regression
	jsr	doc2p
	jsr	db
	jsr	g2p96_gameplay_present_probe	;c86zel: 160x96 mini-frame gameplay P96 diagnostic probe
	ifne	g2p96_overlay_enabled
...
; -----------------------------------------------------------------------------
; c86zel: larger blocky 160x96 gameplay mini-frame after c86zek proved visible
...
; briefly from the gameplay context, draws a larger 160x96 monochrome block map
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: mini-frame 160x96 OK',10
...
.have_p96
	...
	bra	.log
.try_marker
	jsr	g2p96_gameplay_mini_frame_160x96_probe
.log
...
g2p96_gameplay_mini_frame_160x96_probe
	push
	move.l	p96modeid,d0
	beq	.nomode
	move.l	d0,p96winprobe_displayid_tag+4
...
; mini-frame probe: a 160x96 blocky monochrome view sampled from the current
...
g2p96_gameplay_short_wait
	push
	moveq	#8,d7	;short visible gameplay-time P96 marker, then back to AGA
.wait
	move.l	p96gameplay_grbase,d0
	beq	.done
	move.l	d0,a6
