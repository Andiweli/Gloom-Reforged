...
g2p96_workbench_front_enabled	equ	-1	;c86zd9: push hidden AGA/custom screen behind Workbench so P96 live preview stays visible
	;
...
g2p96_workbench_front_for_preview	push
	...
	move.l	d0,a0
	move.l	int(pc),a6
	jsr	-240(a6)	;Intuition ScreenToBack(screen): Workbench/P96 should become visible again
.done	pull
	rts
