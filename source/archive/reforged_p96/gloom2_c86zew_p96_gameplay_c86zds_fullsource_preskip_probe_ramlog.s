...
.wait2	tst	showflag
	...
	bsr	vwait
	bra.s	.wait2
.waitskip2	; c86zew: probe P96 from the same timing window as old c86zds, before doc2p/db
	jsr	g2p96_gameplay_present_probe	;c86zew: c86zds full-source pre-AGA-present probe
	jsr	doc2p
	jsr	db
	ifne	g2p96_overlay_enabled
...
p96gameplay_msg_ok	dc.b	'P96 gameplay: c86zds full-source preskip OK',10
