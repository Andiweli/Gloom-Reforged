	...
	;gloom2p96_c86zec: P96-primary fixes: BlackMagic palette guard, centred Window Size copy, audio-safe frame pacing test.
	;
...
.agaa	bsr	loadfiles
	...
	jsr	g2p96_present_planar_showbitmap_to_window	;c86zdw: force BlackMagic after display-on
	; c86zdx: explicitly keep the RTG/P96 BlackMagic page visible for a
	; short boot splash window before later loading/title code can replace it.
	move	#75,d7	;c86zdy: keep BlackMagic visible longer once real picture is loaded
.g2p96_bm_hold
	jsr	g2p96_present_planar_showbitmap_to_window
	jsr	vwait
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86zec blackmagic/wsize/audio-test active',10
...
g2p96_preview_frame	push
	...
	and	#1,d0		;c86zec: audio-safe test: update P96 every 2nd frame to reduce music/P96 bus chatter
	bne.w	.done
