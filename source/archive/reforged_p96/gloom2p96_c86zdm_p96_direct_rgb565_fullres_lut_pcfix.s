	...
	;gloom2p96_c86zdl: direct RGB565 full 320x240 source copy using a palette->RGB565 LUT; c86zdk colour byteorder kept, HUD readability test.
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86zdl RGB565 fullres LUT active',10
...
; c86zdl: build a direct source-byte -> byteswapped RGB565 lookup table.
...
; c86zdl: direct full-resolution 320x240 chunky -> RGB565 RTG copy.
; This is the first readability-oriented P96 output test: no 160x120 source,
; no BestPen/RectFill, and no doubled coarse samples.
...
p96palpen_map	dcb.b	256,0
	even
; c86zdl: source chunky byte -> target byte-swapped RGB565 word.
