...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 320x192 framebuffer mirror active',10
...
.c25expandrow
	...
	;gloom2p96_c26: mirror the expanded 320-byte row into an optional
	;full 320x192 linear frame buffer, duplicating vertically.  This buffer
	;is not yet used for visible output; it only proves allocation and
	;per-frame filling before a later direct row/pixelarray path.
