	...
	;gloom2p96_c19: safe monochrome luma preview, no P96 pen/palette manipulation, AGA unchanged.
	;
...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 160x96 monochrome luma active',10
...
.c15fallback
	...
	moveq	#11,d1
.c19luma
	; gloom2p96_c19: avoid the random multi-pen colour ramp without
	; touching the Workbench/P96 palette.  The preview is reduced to a
	; safe two-pen luminance mask: pen 0 = dark, pen 1 = lit.
	cmp	#5,d1
	bgt	.c19lit
	moveq	#0,d0
	bra	.c15mapped
