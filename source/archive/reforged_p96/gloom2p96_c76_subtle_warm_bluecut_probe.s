...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c76 subtle warm bluecut probe active',10
...
g2p96_c73_palready
	...
	; gloom2p96_c76: keep c75's correct direct palette->BestPen path,
	; but add only a very small warmth correction.  Do NOT boost green
	; globally like c74 (Shrek mode).  Just trim the blue 4-bit nibble by
	; one step when non-zero before asking ObtainBestPenA for a matching
	; colour.  This should move grey/red textures slightly toward the
	; original warmer green/brown mood without tinting the whole image.
	move	d6,d4
	move	d4,d0
	and	#$000f,d0
	beq	.c76nobluecut
