...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c86zeu5 native locked bitmap writer active',10
...
.lut_ready
	...
	bra.w	.full_rts
.locked_bitmap
	move.l	p96lock_memory(pc),a3	; destination memory from RenderInfo
	moveq	#0,d4
	move	p96lock_bpr(pc),d4	; pitch from RenderInfo
