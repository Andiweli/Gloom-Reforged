...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: 160x96 buffered runfill active',10
...
p96run_start	dc	0	;gloom2p96_c15: x start for horizontal same-pen runfill
	;gloom2p96_c22: internal 160x96 preview pen buffer.  The next
	;step towards a real P96 pixel/array path is to decouple sampling from
	;drawing first, while still using the proven RectFill output as fallback.
p96preview_buf	ds.b	160*96
	even
...
.nolog	movem.l	d0-d7/a0-a6,-(a7)
	...
	; gloom2p96_c22: first safe buffered stage.  c17/c18a/c21 proved
