...
p96prevlog_name	dc.b	'RAM:gloom_p96_preview.txt',0
	even
p96prevlog_ok	dc.b	'P96 preview: c79 subtle palette saturation probe active',10
...
g2p96_c73_palready
	...
	; gloom2p96_c79: c76/c77/c78 proved that explicit green/blue
	; heuristics hit the wrong texture spots.  Keep c75's good direct
	; palette->BestPen path, but ask for a very slightly more saturated
	; version of each original palette colour.  This preserves the palette
	; hue instead of forcing green globally: dominant channels get nudged
	; by only one 4-bit step, grey/balanced entries stay essentially stable.
	move	d6,d4
	move	d4,d0
	and	#$0f00,d0
	lsr	#8,d0		;R nibble
	...
	add	d1,d3
	add	d2,d3
	divu	#3,d3		;average nibble in low word
	cmp	d3,d0
	ble	.c79norboost
	cmp	#15,d0
	beq	.c79norboost
